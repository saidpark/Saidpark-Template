...
<title>iPhone jailbreak - Absinthe 2.0 : Jailbreak iOS 5.1.1 untethered pour iPhone!| iPhone 4S, iPhone 4, iPhone 3GS, iPhone 3G, iPhone 2G</title>
<META name=title content="iPhone jailbreak - Absinthe 2.0 : Jailbreak iOS 5.1.1 untethered pour iPhone!| iPhone 4S, iPhone 4, iPhone 3GS, iPhone 3G, iPhone 2G">
<meta name="description" content="Vous l'attendiez tous ce fameux jailbreak pour iPhone 4S et bien le voila! Ce tutoriel marche aussi pour le 3GS avec la mise à jour de Redsnow(0.8 et plus)." />
<meta name="keywords" content="absinthe 2.0, nouvel jailbreak, hack, crack, tethered, untethered, untether, ios, os, ios5, ios5.0, ios5.0.1, os5.0, os5.0.1, 5.0, 5.0.1, iphone, iphone3gs, iphone4, iphone4s, 3gs, 4s, ipodtouch, itouch, ipod touch, 3g, 4g, 2g, ipad, ipad2, ipad2g, cydia, dev-team, dev team, chronic, greenpois0n, greenpoison, green poison, rednsow, redsn0w, apple, tuto, tutoriel, tutorial, steven, fr, french, francais, itiap, mac, pc, windows, firmware, telecharger, installer, gratuit, new corona, itunes, pod2g, musclenerd," />
...
.Style25 {color: #0099CC; font-family: Arial, Helvetica, sans-serif; font-weight: bold; font-size: 15px;}
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    ...
    <p align="center" class="Style14"><a href="./iphone-jailbreak-absinthe-2-0-ios-5-1-1-untethered.php">iPhone astuces </a> </p>
    <p align="center" class="Style12">Absinthe 2.0 : Jailbreak iOS 5.1.1 untethered pour iPhone ! </p><br>    </td>
  </tr>
  <tr>
    ...
    <td rowspan="2"><table width="587" height="615" border="0">
      <tr>
        <th scope="col"><div align="left" class="Style10">
          <div class="fb-like" data-href="./iphone-jailbreak-absinthe-2-0-ios-5-1-1-untethered.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
          <p class="Style6">Vous possédez un iPhone 4 ? Pourquoi ne pas profiter du Jailbreak ?Tout d’abord une petite explication s’impose, le terme « Jailbreak » signifie que vous allez pouvoir installer sur votre iPhone 4 des applications non validées officiellement par Apple,Chacun attends le jailbreak untethered 5.1.1 pour l'iPhone 4S, de l'iPad 2 et de l'iPad 3 (le nouvel iPad). Sachez que la dernière version de Absinthe 2,0 viens juste d'être libérée par @pod2g . Grace a ce tuto vous pourrez jailbreak votre dispositifs IOS 5.1.1 de facon untetehred . N'oubliez pas de passer a IOS 5.1.1 pour pouvoir utiliser Absinthe 2 !</p>
          <p align="center" class="Style6"><img src="images/iphone4jailbreak-500x375.jpg" alt="iPhone 4S" width="492" height="298"></p>
          <p class="Style6">Absinthe 2  jailbreak untethered 5.1.1 est compatible avec les dispositifs suivant :</p>
          <p><span class="Style23">* ipod 4G * AppleTV 2 * 3GiPod * 3GSiPhone * iPhone 4 et 4 CDMA *iPhone 4S *iPad 1 * iPad 2 Wifi * iPad 2 GSM * iPad 2 CDMA * iPad 3 Wif * iPad 3 CDMA * iPad 3 Global</span><span class="Style5">.</span></p>
        </div></th>
        </tr>
      ...
      </div><p><span class="Style6">NOTE : Si vous êtes sur Windows Vista ou Windows 7 alors que vous devraient ouvrir absinthe en mode administrateur . <br>
NOTE : Les appareils doivent êtres sur IOS 5.1.1 ! </span></p>
    <p align="center"><span class="Style25">Enfin, voici une vidéo résumant ce que vous devez faire :</span></p>
    <p align="center">
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <p class="Style6">1- Branchez votre iphone ou ipad au PC /Mac <br>
        2-- Télécharger et lancer Absinthe 2.0 Windows/Mac/linux<br>
        3- Cliquez sur le bouton "jailbreak" <br>
        4 - Laisser se déroulé le processus de jailbreak de Absinthe 2 <br>
        5- L'icône de Cydia devrait apparaître quelque part sur votre springboard <br>
      6- Ouvrez cydia et laissez-le préparer le système de fichiers (votre dispositif respring une fois fait) et votre iPad 2/3 ou iPhone 4S sera jailbreak untethered sur IOS 5.1.1.</p>      <p class="Style6">Une fois votre iPhone est jailbreaké consulter notre cours pour installer une application ou un jeu sur l’iPhone à partie de App Store et iTunes qui ce trouve ici ===&gt; <a href="./installer-une-application-iphone-depuis-iTunes-et-app-store.php">Installer une application sur l’iPhone depuis App Stor et iTunes</a><br>
        <br>
      </p></td>
