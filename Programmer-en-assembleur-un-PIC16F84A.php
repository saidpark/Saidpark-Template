...
<title>Cours d'électronique à la marocaine : Programmer en assembleur un PIC16F84A</title>
<META name=title content="Cours d'électronique à la marocaine : Programmer en assembleur un PIC16F84A">

<META lang=fr name=description content="Le PIC16F84 est un microcontrôleur de la famille PIC de contrôleurs produites par Microchip Technology pour le stockage des informations. Pour programmer un microcontrôleur il est nécessaire de disposer d’un éditeur de texte pour rédiger les programmes, d’un logiciel d’assemblage pour le traduire en langage machine et si possible d'un simulateur pour mette son programme au point. " />
<meta name="keywords" content="assembleur, asm, assembler, mplab, mpasm, pic, microchip, 16f84, 16c84, 12c508, 12c508a, modchip, comment, programmer, bases, variables, debutant, programmation, structure, programme,Micro-contrôleur PIC 16F84" />
...
<div align="right" bgcolor="#ffffff">
    ...
    <th width="160" rowspan="4" scope="col" bgcolor="#FFFFFF" bordercolor="#FFFFFF"><div class="savestatus">
<p><div class="fb-like-box" data-href="https://www.facebook.com/" data-width="160" data-height="400" data-show-faces="true" data-stream="false" data-show-border="true" data-header="true"></div></p></div>
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Programmer-en-assembleur-un-PIC16F84A.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique</a></p>
    <p align="center" class="Style12">Programmer en assembleur un PIC16F84A</p>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Le PIC16F84 est un microcontrôleur de la famille PIC de contrôleurs produites par Microchip Technology.pour le stockage des informations.Le programme peut se<br>
          faire de 3 manières, en ROM, EEPROM et mémoire flash.</p>
          <p class="Style6">il est important de prêter attention aux niveaux électriques.<br>
            Les μc de MICROCHIP utilisent des niveaux TTL 0-5V. Il faut donc veiller lors de la réalisation d’un montage, à ne jamais appliquer une tension supérieure aux pattes ce qui détruirait<br>
            immédiatement le circuit.</p>
          <p class="Style6">Pour programmer un microcontrôleur il est nécessaire de connaître sa structure interne : registres, mémoires, ports d’entrées sorties, et toutes leurs possibilités.<br>
            Il faut aussi disposer d’un éditeur de texte pour rédiger les programmes, d’un logiciel d’assemblage pour le traduire en langage machine et si possible d'un simulateur pour mette son programme au point.</p>
          <p class="Style6">Je résumerais ici la “data sheet” du 16F84 en disant qu’il s’agit d’une puce 18 pattes programmable et dont les caractéristiques essentielles sont les suivantes :<br>
            – Mémoire flash 1k mots de 14 bits<br>
            – 68 octets de RAM pour le stockage des variables non rémanantes<br>
            – 64 octets d’EEPROM ce qui permet de stocker des variables rémanantes, réglages, paramètrages
            <br>
            – Architecture RISC (signifie jeu d’instruction réduit)<br>
            – 13 ports E/S<br>
            – Fréquence d’horloge 4 MHz pour les plus courants et jusqu’à 20 MHz selon le modèle</p></td>
        <td width="175"><p align="right"><img src="images/Pic1.gif" alt="PIC16F84A" width="180" height="205"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
