...
<title>Création de site web : Créer votre site facilement avec joomla</title>
<META name=title content="Création de site web : Créer votre site facilement avec joomla">

<META lang=fr name=description content="Cette formation sur Joomla! s´adresse à toute personne qui débute sur l´utilisation de gestionnaire de contenu en général et qui souhaite être plus particulièrement accompagnée dans l´installation, la configuration et la prise en main générale de Joomla!" />
<meta name="keywords" content="joomla tutorial, cour joomla, maroc joomla, arab joomla, menu joomla, menu simple joomla, formation menu joomla, créer menu joomla, joomla section, categorie joomla" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./creation-de-site-web-avec-joomla.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./creation-de-site-web-avec-joomla.php">Formation Joomla </a></p>
    <p align="center" class="Style12">Création de site web : Créer votre site facilement avec joomla</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Cette formation sur Joomla! s´adresse à toute personne qui débute sur l´utilisation de gestionnaire de contenu en général et qui souhaite être plus particulièrement accompagnée dans l´installation, la configuration et la prise en main générale de Joomla!<br>
          Nous installerons joomla sur un serveur local. Ce qui nous permettra de ne pas être dépendants d'un fournisseur d'hébergement et de pouvoir démarrer de suite la mise en pratique.<br>
          La deuxieme étape qui suit la configuartion de Joomla, c´est de choisir et installer une Template, aussi de définir un Logo, ainsi un header, en utilisant les sources Photoshop fournies par la template, la méthode d´installation peut se faire de deux manières, soit un upload direct, soit via FTP, donc il faut voir le cours pour découvrir le chemin à suivre.</p>
          </td>
        <td width="175"><div align="right">
          <p><img src="images/joomla.png" alt="joomla" width="252" height="229"></p>
          </div></td>
      </tr>
