...
<title>Cours d'électronique numérique en dialecte marocain | Maroc Formation</title>
<META name=title content="Cours d'électronique numérique en dialecte marocain | Maroc Formation">

<META lang=fr name=description content="Voici des cours d'électronique numérique pour débutant ou profesionnel en dialecte marocain (Darija) alors profitez en, l'informatique et l'échange de savoir vous intéresse? Cet espace est fait pour vous." />
<meta name="keywords" content="cours, formation en electronique, cours d'electronique, electronique numerique,electrinique analogique, apprendre l'electronique" />
...
.Style32 {font-size: 17px; color: #0099CC; font-family: Arial, Helvetica, sans-serif; font-weight: bold; }
-->
</style>
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./cours-electronique-numerique.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./cours-electronique-numerique.php">Electronique numérique</a></p>
    <p align="center" class="Style12">Cours d'électronique numérique</p><br>   </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">L'électronique numérique est un domaine scientifique s'intéressant aux systèmes électroniques dont les états parcourent un ensemble fini de possibilités. Le déterminisme dans les changements d'état (transitions) permet de disposer de systèmes qui se comportent de manière stable et fiable. Elle permet en particulier de s'affranchir de parasites et autre déformations.<br>
          Ce type d'électronique est opposé à l'électronique analogique, qui, elle, traite des systèmes électroniques opérant sur des grandeurs (tension, courant, charge) variant de manière continue.</p>
          </td>
        <td width="175"><div align="right"><img src="images/Carte_Electronique.JPG" alt="l'éléctronique numérique" width="241" height="168"></div></td>
      </tr>
    </table>    
    <p align="left" class="Style6"><span class="Style12">Partie 1: Introduction à l'électronique numérique</span><br>
    </p>
   
    <p align="left" class="Style12">Partie 2 : Système de numération</p>
    
    <p align="left" class="Style32">Télécharger les cours en format PowerPoint </p>
    <p align="left" class="Style6"> La logique séquentielle : </p>
    <p align="left" class="Style6">La logique combinatoire : ici </p>
    <p align="left" class="Style6">Le système de numération : </p></td>
  </tr>
  <tr>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td><p class="Style32">Les microcontrôleurs PIC
      <p class="Style6">Les microcontrôleurs PIC (ou PICmicro dans la terminologie du fabricant) forment une famille de microcontrôleurs de la société Microchip. Ces microcontrôleurs sont dérivés du PIC1650 développé à l'origine par la division microélectronique de General Instrument.<br>
