...
<title>Formation réseau à la marocaine CCNA : Switching (Commutation LAN)</title>
<META name=title content="Formation réseau à la marocaine CCNA : Switching (Commutation LAN)">

<META lang=fr name=description content="Switching ou bien Commutation LAN est une forme de commutation de paquets de la couche 2 du modèle OSI.utilisé dans les réseaux locaux . Les technologies de commutation sont cruciales pour la conception du réseau, car la circulation doit être envoyé que lorsque cela est nécessaire. " />
<meta name="keywords" content="switching, LAN, commutation, ccna, commutation lan, mac adresse, IEEE, couche 2, ip, paquet, routage, OSPF, RIP, EGP, BGP, réseaux, réseau informatique, sécurité réseau, logiciel réseau, configuration réseau, réseau informatiques, administration réseau, architecture réseau, cours réseau, subnetting, static route, routage statique" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Formation-reseau-ccna-switching-commutation-LAN.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Formation-reseau-ccna-switching-commutation-LAN.php">Formation réseau </a></p>
    <p align="center" class="Style12">Formation  réseau à la marocaine :  Switching (Commutation LAN) </p><br>    </td>
  </tr>
  <tr>
    ...
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><span class="Style12">1 - Présentation</span></p>
          <p class="Style6"><em>Switching ou bien Commutation LAN</em> est une forme de commutation de paquets utilisé dans les réseaux locaux . Les technologies de commutation sont cruciales pour la conception du réseau, car la circulation doit être envoyé que lorsque cela est nécessaire. </p>
          <p class="Style12">2 - Caractéristiques et fonctionnement</p>
          <p class="Style6">les commutateurs, sont des équipements de la couche 2 du modèle OSI.</p>
          <p class="Style6">Quand une trame arrive à un port, le pont va consulter sa table de pontage pour connaître le port par lequel la trame doit être envoyée à l’adresse MAC de destination. Dans ce cas, si :<br>
            • Le port de destination est le même que celui qui a reçu la trame, la trame ne sera pas transmise sur d’autres ports : <em><strong>c’est le filtrage.</strong></em><br>
            • Le port de destination est un port différent de celui par lequel la trame a été reçue, le pont transmet cette trame sur le port correspondant : <em><strong>c’est la commutation.</strong></em></p>
          <p class="Style6"><span class="Style12">Prérequis</span></p>
          <p class="Style6">Ce tutorial demande des connaissances théoriques sur l'adressage IP, présentées dans le chapitre <a href="./Cours-informatique-reseaux.php" target="_blank">« Couche Réseau ». </a>Une introduction à la configuration des routeurs Cisco est donnée dans le chapitre <a href="./configuration-des-routeurs-cisco.php" target="_blank">« Introductions routeurs Cisco »</a>. et le chapitre « <a href="./les-sous-reseaux-subnetting-IPv4-exemples-et-exercices.php" target="_blank">Les sous-réseaux subnetting IPv4 exemples et exercices</a> » Il est recommandé d'en prendre connaissance avant de voir ce chapitre</p></td>
        <td width="175"><p align="right"><img src="images/1013073_209069952577720_1593983979_n.jpg" alt="switching ccna" width="259" height="166"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
