...
<title>installation et configuration du serveur DHCP Sous Linux Mandriva</title>
<META name=title content="installation et configuration du serveur DHCP Sous Linux Mandriva">

<META lang=fr name=description content="Aprés avoir installer le serveur DNS Maintenant nous allons configurer le service DHCP, qui est l’attribution automatique d’adresse IP par le serveur. Ainsi que la possibilité d’exclure certaines plages d’adresse et la notion de bail" />
<meta name="keywords" content="serveur DNS, Bind, Mandriva Linux, cours Darija, serveur DHCP, serveur FTP, cache DNS, named.conf, serveur web, hebergé, heberger web, webmin, administrateur linux, cours darija maroc, tutorial darija, " />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Installer-et-configurer-le-serveur-DHCP-Sous-Mandriva-Linux.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Installer-et-configurer-le-serveur-DHCP-Sous-Mandriva-Linux.php">Administration des systèmes Linux en Darija Marocaine </a></p>
    <p align="center" class="Style12">installation et configuration du serveur DHCP Sous Linux Mandriva</p>
    <br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="586" height="77" border="0">
      <tr>
        <td width="376"><p class="Style6"><strong>1. Introduction et pré-requis:</strong></p>
          <p class="Style6"> Nous allons étudier la mise en oeuvre de trois services :</p>
          <ul>
            <li class="Style6"><a href="./Tutorial-configuration-DNS-sous-Linux-Mandriva.php" target="_blank">Le serveur DNS Bind Sous Mandriva Linux (installation et configuration)</a></li>
            <li class="Style6"><a href="./Installer-et-configurer-le-serveur-DHCP-Sous-Mandriva-Linux.php" target="_parent">Installer et configurer le serveur DHCP Sous Mandriva</a></li>
            <li class="Style6"><a href="./Installer-et-configurer-le-serveur-FTP-Sous-Mandriva-Linux.php" target="_blank">Installer et configurer le FTP Sous Mandriva Linux</a></li>
          </ul>
          <p class="Style6"><strong>1.1 Présentation</strong></p>
          <p class="Style6">Aprés avoir<a href="./Tutorial-configuration-DNS-sous-Linux-Mandriva.php" target="_blank"> installer le serveur DNS</a> Maintenant nous allons configurer le service DHCP, qui est l’attribution automatique d’adresse IP par le serveur. Ainsi que la possibilité d’exclure certaines plages d’adresse et la notion de bail.</p>
          <p><strong>1.2 Configuration du Serveur DHCP</strong></p>
          <p class="Style6"> <span class="Style33">a) Côté Serveur</span><br>
            L'installation du logiciel nécessaire :<br>
            Pour pouvoir configurer le DHCP, il vous faut installer le logiciel &quot;dhcp-server&quot;: allez dans le Menu --&gt; Outil --&gt; Outil système --&gt; Installer et désinstaller des logiciels --&gt; « dhcp-server » --&gt; Appliquer --&gt; OK.</p>
          <p class="Style6"><span class="Style33">b) Côté client</span><br>
            Pour pouvoir configurer le DHCP, il vous faut installer le logiciel « dhcp-client »: allez dans le Menu --&gt; Outil --&gt; Outil système --&gt; Installer et désinstaller des logiciels --&gt; « dhcp-client » --&gt; Appliquer --&gt; OK.</p>
          <p class="Style6">Il faut lui indiquer qu’il va recevoir une adresse IP de façon automatique.<br>
            Allez dans le Menu --&gt; Internet --&gt; Centre réseau --&gt; Filaire (Ethernet) --&gt; Configurer --&gt; « Attribution automatique de l'adresse IP (BOOTP/DHCP) » &gt; OK.</p>
          <p class="Style6"><span class="Style33">c) Tests du service DHCP</span><br>
            Tester l’attribution automatique d’adresse IP sur le poste client, en excluant l’adresse 192.168.2.2 par exemple.<br>
            Attendre la moitié du temps de bail et vérifier que l’adresse attribuer au client est bien : 192.168.2.3.<br>
          </p>
          </td>
        <td width="200"><p align="right"><img src="images/mandriva-logo.jpg" alt="switching ccna" width="197" height="144"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
      ...
      <p class="Style12">Tutorial : installation et configuration du serveur DHCP Sous Linux Mandriva</p>
