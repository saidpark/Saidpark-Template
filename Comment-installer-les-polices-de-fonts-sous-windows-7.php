...
<title>Comment installer les polices de fonts sous windows 7 | Astuces Windows</title>
<META name=title content="Comment installer les polices de fonts sous windows 7 | Astuces Windows">

<META lang=fr name=description content="Windows est fourni avec plusieurs fonts d'ecritures déjà installées. Si vous souhaitez installer des nouveaux fonts d'écritures supplémentaires, vous devez d'abord télécharger les fonts à partir..." />
<meta name="keywords" content="fonts d'ecriture, polices de fonts, fonts windows 7, télécharger les fonts,
fonts arabes, fonts photoshop, fonts windows 8," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Comment-installer-les-polices-de-fonts-sous-windows-7.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Comment-installer-les-polices-de-fonts-sous-windows-7.php">Astuces Windows </a></p>
    <p align="center" class="Style12">Comment installer les polices de fonts sous windows 7</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Windows est fourni avec plusieurs  fonts d'ecritures déjà installées. Si vous souhaitez installer  des nouveaux fonts d'écritures supplémentaires, vous devez d'abord les télécharger. Vous pouvez télécharger les fonts à partir : <span class="Style33">www.dafont.com</span></p>
          <p align="center" class="Style6"><img src="images/folder_fonts.png" alt="fonts police" width="206" height="184"></p>
          <p class="Style6">le fichier de police, souvent inclus dans une archive type .rar ou .zip, il faut decompresser l'archive pour obtenir le fichier de police .ttf ou autre.<br>Copier/coller le font d'écriture dans : C:\WINDOWS\Fonts, vous pouvez normalement accéder au dossier de stockage des polices par &quot;demarrer/parametres/panneau de config/polices&quot; suivant votre version de windows.<br>
            Aprés l'installation la police  sera ensuite disponible dans les logiciels de traitement de texte et dans la plupart des logiciels ayant acces à ce dossier de polices genre photoshop, dreamweaver,microsoft office...</p>
          </td>
        <td width="175"><div align="right"><img src="images/Web_fonts.png" alt="fonts" width="295" height="213"></div></td>
      </tr>
