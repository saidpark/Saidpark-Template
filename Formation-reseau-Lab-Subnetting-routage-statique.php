...
<title>Formation réseau à la marocaine : Lab Subnetting routage statique</title>
<META name=title content="Formation réseau à la marocaine : Lab Subnetting routage statique">

<META lang=fr name=description content="Le but de ce cours est d’apprendre à configurer les routes statiques sur un routeur Cisco. Des hôtes qui ne sont pas sur le même réseau devront pouvoir communiquer. pour cela nous commencerons par configurer les routeurs, puis nous ajouterons les routes statiques. " />
<meta name="keywords" content="réseaux, réseau informatique, sécurité réseau, logiciel réseau, configuration réseau, réseau informatiques, administration réseau, architecture réseau, cours réseau, subnetting, static route, routage statique" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Formation-reseau-Lab-Subnetting-routage-statique.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Formation-reseau-Lab-Subnetting-routage-statique.php">Formation réseau </a></p>
    <p align="center" class="Style12">Formation réseau à la marocaine : Lab Subnetting routage statique</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><span class="Style12">Introduction</span></p>
          <p class="Style6">Le but de ce cours est d’apprendre à configurer les routes statiques sur un routeur Cisco.<br>
            Des hôtes qui ne sont pas sur le même réseau devront pouvoir communiquer. pour cela nous commencerons par configurer les routeurs, puis nous ajouterons les routes statiques.</p>
          <p class="Style6">On commence la configuration des Routeurs par leurs donner des noms. cette action va permettre de ne pas se perdre entre les différents routeurs. Nous configurons ensuite les interfaces fastethernet , pour leurs donner les adresses ip, pour finir nous réalisons des ping pour tester le bon fonctionnement des liaisons de notre réseau.</p>
          <p class="Style12">Remarque</p>
          <p class="Style6">Pour que ces ping  fonctionnent correctement nous allons configuré les routes qui vont permettre aux routeurs de transmettre correctement nos paquets d’une extrémité du réseau à une autre.</p>
        ...
        <td width="175"><p align="right"><img src="images/network_img1.jpg" alt="static route subnetting" width="224" height="217"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
