...
<title>Programmer plusieurs afficheur 7 segments pic 16F84 en MiKroC (le multiplexage) | Maroc électronique et robotique</title>

<META name=title content="Programmer plusieurs afficheur 7 segments pic 16F84 en MiKroC (le multiplexage) | Maroc électronique et robotique">

<META lang=fr name=description content="Le but de ce cours est de programmer une cible (un affichage 7 segments) mais surtout de comprendre comment convertir une donnée binaire en donnée décimale. Le coeur du montage est constitué par un microcontroleur ou pic (16F84) suivi par un décodeur binaire vers affichage 7 segments. " />
<meta name="keywords" content="Programmation, Mikroc, compiler, afficheur, LCD,Programmation sur Mikroc, afficheur LCD, multiplexage afficheurs, afficheurs segments, afficheurs 11 segments, afficheurs segments vhdl, afficheurs segments pdf, forum afficheurs segments, voltmetre afficheurs segments,programmation PIC 16F877,afficheurs 7 segments , Électronique, Multiplexage de 2 afficheur, Afficheurs segments, Multiplexage 7 segments, Multiplexage,PIC,Multiplexage PIC,electronique,robotique,PIC,robot,robots," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./programmer-un-afficheur-7-segments-avec-microcontroleur-pic-16f84-en-MiKroC-et-ISIS.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./programmer-un-afficheur-7-segments-avec-microcontroleur-pic-16f84-en-MiKroC-et-ISIS.php">Cours de programmation Microcontroleur PIC16F84</a></p>
    <p align="center" class="Style12"> Programmer un afficheur 7 segments microcontroleur pic 16f84 en MiKroC</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style12"><span class="Style6"><em><strong>Les afficheurs 7 segments</strong></em> sont un type d'afficheur très présent sur les calculatrices et les montres à affichage numérique : les caractères (des chiffres et des lettres soient utilisées pour l'affichage hexadécimal) s'écrivent en allumant ou en éteignant des segments, au nombre de sept. Quand les 7 segments sont allumés, on obtient le chiffre 8.</span></p>
          <p class="Style6">Le but de ce cours est  de programmer une cible (un affichage 7 segments) mais surtout de comprendre comment convertir une donnée binaire en donnée décimale.<br>
            Le coeur du montage est constitué par un microcontroleur ou pic (16F84) suivi par un<br>
            décodeur binaire vers affichage 7 segments.</p>
          </td>
        <td width="175"><p align="right"><img src="images/minuteur.JPG" alt="afficheur 7 segments microcontrôleur pic 16f84" width="276" height="261"></p>
          </td>
      </tr>
    </table>    
      <p><span class="Style12">Cours n°1: Programmer un afficheur 7 segments microcontroleur pic 16F84 en MiKroC</span></p>
      
      <p align="left" class="Style12">Cours n°2: Programmer plusieurs afficheur 7 segments  pic 16F84 en MiKroC (le multiplexage)</p>
      </td>
  </tr>
  <tr>
