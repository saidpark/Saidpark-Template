...
<title>Programmer un afficheur LCD avec microcontrôleur PIC 16F84 | Maroc électronique et robotique</title>
<META name=title content="Programmer un afficheur LCD avec microcontrôleur PIC 16F84 | Maroc électronique et robotique">

<META lang=fr name=description content="Le but principal de ce projet est d’afficher sur l’écran LCD des valeurs données par différents capteurs. Le travail à effectuer peut se décomposer en deux grandes parties. En effet il faut tout d’abord réaliser la conversion de la mesure analogique du capteur en valeur numérique. Puis ensuite il faut afficher cette valeur numérique sur l’écran LCD." />
<meta name="keywords" content="Afficheur,LCD,2,16,microcontroleur,PIC,Afficheur LCD 2*16 microcontroleur,controleur,choisir,pic16F84, programmation pic 16f88, PWM PIC 16F88, écran LCD, afficheur numérique,PCW," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./afficheur-LCD-avec-microcontroleur-PIC-16F84.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./afficheur-LCD-avec-microcontroleur-PIC-16F84.php">Cours de programmation Microcontrôleur PIC16F84</a></p>
    <p align="center" class="Style12">Programmer un afficheur LCD avec microcontrôleur PIC 16F84 </p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><span class="Style12">1 - Présentation du projet</span></p>
          <p class="Style6">Le but principal de ce projet est d’afficher sur l’écran LCD des valeurs données par différents capteurs. Le travail à effectuer peut se décomposer en deux grandes parties. En effet il faut tout d’abord réaliser la conversion de la mesure analogique du capteur en valeur numérique. Puis ensuite il faut afficher cette valeur numérique sur l’écran LCD.</p>
          <p class="Style12">2 - Objectif du projet</p>
          <p class="Style6">Un micro contrôleur PIC 16F84, sera utilisé afin de faire la mise en forme et le formatage des signaux des capteurs. Ainsi à partir d’une valeur de tension comprise entre 0 et 5 volts on obtiendra une grandeur physique dont l’unité sera appropriée. Ce PIC dispose de nombreux modules permettant de réaliser diverses applications telles que la conversion analogique numérique et la gestion de l’affichage d’un écran LCD. Afin que le micro contrôleur puisse les réaliser il faut configurer les registres c'est-à-dire mettre les bits de ceux-ci à 1 ou 0 en les programmant en langage C.</p>
        ...
        <td width="175"><p align="right"><img src="images/lcd_avant.jpg" alt="afficheur LCD  microcontroleur PIC 16F84" width="278" height="195"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
