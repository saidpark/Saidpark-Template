...
<title>Enfin au Maroc La virtualisation des serveurs et du stockage (Cloud Computing) | Formarion Gratuite</title>

<META name=title content="Enfin au Maroc La virtualisation des serveurs et du stockage (Cloud Computing) | Formarion Gratuite">

<META lang=fr name=description content="Voici la premiére formation gratuite au Maroc en virtualisation de serveurs basée sur le produit vSphere de VMware. Cette formation vous permettra d’acquérir des compétences pratiques et opérationnelles et de passer le test de certification internationale de VMware." />
<meta name="keywords" content="VMware vSphere, VMware ESX, Microsoft Hyper-V Server, Oracle VM, VMware formation, vmware tutorial,certification,tutoriel,tuto,thinApp,virtualisation,serveur,client,bureaux,client View,clones, cloud computing, la virtualisation , stockage , backup, sécurité, plateformes , vmware , citrix , microsoft,Hyperviseur, Hyper-V , VMware ESX , Xen, Serveur dédié, virtuel, Linux-VServer, VirtualPC, Virtual Server, LXC ,Machine virtuelle, KVM, Parallels Desktop, Plex86,QEMU, VirtualBox,systèmes d'exploitation, Hébergeur Web, AIX," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./la-virtualisation-et-le-cloud-computing-formation-gratuite.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./la-virtualisation-et-le-cloud-computing-formation-gratuite.php">Formation Gratuite au Maroc  ; La virtualisation  Vmware vSphere.</a></p>
    <p align="center" class="Style12"> La virtualisation des serveurs et du stockage  (Cloud Computing) </p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><span class="Style6">Voici la premiére formation gratuite au Maroc en virtualisation de serveurs basée sur le produit vSphere de VMware. Cette formation vous permettra d’acquérir des compétences pratiques et opérationnelles et de passer le test de certification internationale de VMware</span></p>
          <ul>
            <li class="Style6">Introduction à la virtualisation de Vmware</li>
            <li class="Style6">Création de machines virtuelles sous la forme d’une appliance ESX et ESXi</li>
            <li class="Style6">Déploiement de VMware vCenter Server</li>
            <li class="Style6">Configuration et administration de Réseaux Virtuels</li>
            <li class="Style6">Configuration et administration du stockage avec l’appliance VMware Virtual Storage</li>
            <li class="Style6">Gestion des machines virtuelles, VMware vMotion, vApp vSphere</li>
            <li class="Style6">Protection de données</li>
            <li class="Style6">Contrôle d’accès et authentification, pare-feu &amp; zones vShield </li>
            <li class="Style6">Administration et supervision des ressources à l’aide vCenter Server </li>
            <li><span class="Style6">Installation des composantes de VMware vSphere               </span><br class="Style6">
            </li>
          </ul></td>
        <td width="175"><p align="right"><img src="images/virtualisation.jpg" alt="la virtualisation cloud computing" width="215" height="170"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p></td>
      </tr>
