...
<title>Créer une radio en live Streaming a partir du PC | Tutoriel vidéo | Divers</title>
<META name=title content="Créer une radio en live Streaming a partir du PC | Tutoriel vidéo | Divers">

<meta name="description" content="Le principe est simple : nous avons besoin de Winamp, du serveur IceCast et du plugin OddCast DSP pour Winamp. Winamp va jouer nos morceaux de musique qui vont être encodés en temps réel par le plugin DSP avant d’être envoyés vers le serveur IceCast afin que ce dernier les diffuse, mais sans avoir besoin d´un serveur de streaming audio, seulement à partir de votre pc,  vous pouvez diffuser ainsi, et de parler aux auditeurs de votre radio." />
<meta name="keywords" content="streaming audio recorder, streaming audio, stream audio, record streaming audio, audio streaming, streaming audio host, streaming audio windows, streaming audio tutorial, streaming audio books, how to record streaming audio, streaming audio recorders, streaming audio servers, capture streaming audio, save streaming audio, streaming audio software, streaming audio radio, streaming audio broadcast, real audio streaming, windows media audio streaming, streaming radio, live streaming, radio streaming, streaming media server, hebergement streaming, streaming radio stations, internet broadcast, live stream, Cour vidéo, tutorial vidéo, formation vidéo, formation graphique, tutoriel vidéo, Maroc vidéo, vidéo Maroc, formation Maroc, cour logiciel, apprendre graphisme," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    ...
    <p align="center" class="Style12"><a href="./Creer-une-radio-en-live-Streaming-a-partir-du-PC.php">Astuces internet</a> </p>
    <p align="center" class="Style9">Créer une radio en live Streaming a partir du PC </p><br></td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4"><table width="566" height="191" border="0" align="center">
      <tr>
        <th width="391" height="141" scope="col"><div align="left">
          <div class="fb-like" data-href="./Creer-une-radio-en-live-Streaming-a-partir-du-PC.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
          <span class="Style11">
          
          Le principe est simple : nous avons   besoin de Winamp, du serveur IceCast et du plugin OddCast DSP pour Winamp.   Winamp va jouer nos morceaux de musique qui vont être encodés en temps réel par   le plugin DSP avant d’être envoyés vers le serveur IceCast afin que ce dernier   les diffuse, mais sans avoir besoin d´un serveur de streaming audio, seulement à   partir de votre pc,  vous pouvez diffuser ainsi, et de parler aux auditeurs de   votre radio.</span><br>
          <span class="Style11">winamp:<BR>
            www.winamp.com<BR>
            Serveur IceCast   :<BR>
            http://www.icecast.org/download.php<BR>
            Plugin OddCast DSP pour   Winamp:<BR>
            http://www.oddsock.org/tools/<BR>
            Pour verifier le port   8000:!<BR>
            http://www.radiotoolbox.com/online_tools/cantheygetin.php</span><br>
            <span class="Style11">La liste des lecteurs audio compatibles OGG   Vorbis:<BR>
            http://fr.wikipedia.org/wiki/Ogg_Vorbis#Lecteurs_logiciels</span>
            <p align="right"><a href="http://www.4shared.com/rar/0wOCPpEW/file.html" target="_blank"></a> <BR>
            </p>
        </div></th>
        <th width="165" scope="col"><div align="right"><a href="./Creer-une-radio-en-live-Streaming-a-partir-du-PC.php"><img src="images/radio1.png" alt="radio live streaming" width="160" height="160" border="0"></a></div></th>
      </tr>
      <tr>
