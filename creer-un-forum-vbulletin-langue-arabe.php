...
<title>Création d'un forum vBulletin + langue arabe | Forum et CMS | Internet</title>
<META name=title content="Création d'un forum vBulletin + langue arabe | Forum et CMS | Internet">
<meta name="description" content="vBulletin vous permet de mettre à la disposition de vos visiteurs un forum très performant et entièrement personnalisable.il s'appuie sur un langage utilisé de plus en plus sur le web; le PHP et sur une base de données très efficace et avec un moteur de base de données très performant MySQL.Les fonctionnalités propres à vBulletin font de ce script la référence en matière de forum." />
<meta name="keywords" content="forum vbulletin, vbulletin forum host, vbulletin download, forum topics, forum board, vbulletin hosting, vbulletin host, forum phpbb, forum php, forum smf, theme vbulletin, template vbulletin, forum template, forum theme, vbulletin skins, vbulletin styles, vbulletin web hosting, langage forum, vbulletin arabic, Cour vidéo, tutorial vidéo, formation vidéo, formation graphique, tutoriel vidéo, Maroc vidéo, vidéo Maroc, formation Maroc, cour logiciel, apprendre graphisme" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
	 <div class="fb-like" data-href="./creer-un-forum-vbulletin-langue-arabe.php" data-send="true" data-layout="button_count" data-width="100" data-show-faces="false"></div>
		  <!-- Place this tag where you want the +1 button to render. -->
<div class="g-plusone" data-size="medium"></div>
    <p align="center" class="Style12"><a href="./creer-un-forum-vbulletin-langue-arabe.php">Forum et CMS</a> </p>
    <p align="center" class="Style9">Création d'un forum vBulletin en langue arabe </p><br></td>
  </tr>
  <tr>
     <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4"><table width="566" height="191" border="0" align="center">
      <tr>
        <th width="392" height="141" scope="col"><div align="left">


		<p align="justify" class="Style11">vBulletin vous permet de mettre à la disposition de   vos visiteurs un forum très performant et entièrement   personnalisable.<BR>
            Il s'appuie sur un   langage utilisé de plus en plus sur le web; le PHP et sur une base de données   très efficace et avec un moteur de base de données très performant MySQL. <BR>
            Les fonctionnalités propres à vBulletin   font de ce script la référence en matière de forum. </p>
          <p align="right"> <BR>
            </p>
        </div></th>
        <th width="164" scope="col"><div align="right"><a href="./Cours-programmation-avec-visual-basic.php"></a><img src="images/vbulltin.jpg" alt="Créer un Forum vBulletin" width="150" height="113"></div></th>
      </tr>
      <tr>
      ...
      <tr>
        <td height="21" colspan="2"><div align="left"></td>
        </tr>
    </table>
 <br>
