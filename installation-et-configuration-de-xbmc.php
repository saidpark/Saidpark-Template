...
<title>XBMC: obtenir plus de 8000 chaines TV cryptées sur votre PC!</title>
<META name=title content="XBMC: obtenir plus de 8000 chaines TV cryptées sur votre PC!">

<meta name="description" content="Découvrez le monde de la TV en ligne grâce à XBMC. Vous obtiendrez plus de 8000 chaînes (films, musique, vidéo clip, émissions, informations, sports…) de partout à travers le monde !." />
<meta name="keywords" content="xbmc, XBMC, adsl tv, web tv, web radio, web radios, webcam, webcams, tv, fm, hd, tele, teles, television, televisions, magnetoscope, magnetophone, radio, radios, regarder, enregistrer, programmer, adsl, fai, free, neuf, club internet, aol, darty, dartybox, multiposte, tvsurpc, tv sur pc, televisionsurpc, television sur pc, freebox tv, freebox hd, freeplayer, neuftv, neuf tv, citv, ci tv, club internet tv, aoltv, aol tv, dartytv, darty tv, dartyboxtv, dartybox tv,noos tv sur pc, alicetv, alice tv, belgacomtv, belgacom tv, programme tv, guide tv, epg, bouquet tv, tuner, time shifting, controle du direct, PIP, double direct, telecharger, telechargement, download, application, soft, logiciel, freeware, gratuit, gratuitement, ordinateur, micro, pc, iptv, en ligne, online, tv, television, chaines, radio, webradio, radios, web radio, webtv, web tv, movie, gratuit, gratuitement, gratos, télé, adsl, movies, films, jeux, flash, online, livetv, live, pro, bouquet, chaînes, nettv, net tv, net, nrj, rtl,  europe 1, cherie fm, nostalgie, shoutcast, statistics, icecast, radionomy, tv sur pc, television sur pc, tnt, télévision numérique terrestre, orange tv sur pc, alice tv sur pc, belgacom tv sur pc, free tv sur pc, neuf tv sur pc, free, orange, neuf, belgacom, alice, noos tv sur pc, noos" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97"><div class="fb-like" data-href="./installation-et-configuration-de-xbmc.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
    <p align="center" class="Style14"><a href="./installation-et-configuration-de-xbmc.php">Installation et configuration de mediacenter XBMC </a> </p>
    <p align="center" class="Style12">XBMC : plus de 8000 chaines TV cryptées sur votre PC !</p><br></td>
  </tr>
  <tr>
    ...
    <td rowspan="2"><table width="579" height="164" border="0">
      <tr>
        <th width="573" scope="col"><div align="left">
          <div class="fb-like" data-href="./Changer-votre-ip-adresse-avec-vpn-gratuit.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false">
            <p class="Style6">Le logiciel fonctionne sur toutes les plates-formes Windows XP, Vista et Windows 7 Regarder le monde de plus de 8000 chaînes, y compris des films, les matchs de foot, des comédies, des nouvelles, des canaux de musique, des documentaires.Si vous aimez le Football, avec le logiciel vous ne serez pas déçu car il contient des <strong>milliers de postes de sports</strong> en français, anglais, portugais, italien, espagnol, etc..</p>
            ...
            <ul>
              <li class="Style6"><em><strong>Regardez ce que vous voulez</strong></em> sur votre PC! Aucune carte spécial nécessaire.</li>
              <li class="Style6"><em><strong>Pas de frais mensuels ridicules</strong></em> ou matériel à installer!</li>
              <li class="Style6">Tout ce qu'il vous faut c'est d'installer le logiciel XBMC sur PC!</li>
              <li class="Style6">La plupart des gens sont prêts à payer plus de 60 euros et plus par mois pour la TV câblée.</li>
              <li class="Style6">Avec le logiciel XBMC et sa technologie, <em><strong>il n'ya pas de frais de service mensuels</strong></em>.</li>
              <li class="Style6">N'oublié pas de <em><strong>Télécharger ici</strong></em> les plugins de XBMC pour avoir l'accès aux chaines.</li>
              </ul>
            <div align="center">
              <p><img src="images/tuto[1].jpg" alt="play" width="140" height="50" border="0"></p>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td>  <div class="roknewspager-wrapper">
