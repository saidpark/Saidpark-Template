...
<title>Créer un montage vidéo avec Windows Movie Maker | Logiciels et astuces internet</title>
<META name=title content="Créer un montage vidéo avec Windows Movie Maker | Logiciels et astuces internet">
<META lang=fr name=description content="Windows Movie Maker est un logiciel de montage vidéo fourni avec les systèmes d’exploitation Windows XP, Vista , Windows 7 et Windows 8. il permet de créer des effets spéciaux, des transitions, d’ajouter des textes, des pistes son, timeline, Auto Movie et des captures sonores. C’est un logiciel de montage vidéo pratique et simple." />
<meta name="keywords" content="Windows Movie Maker, windows 7, windows xp, windows 8, montage video, cinema 4D, cinema 3D, after efect, avi, convert to," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Creer-un-montage-video-avec-Windows-Movie-Maker.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Creer-un-montage-video-avec-Windows-Movie-Maker.php">Logiciels et astuces internet</a></p>
    <p align="center" class="Style12">Créer un montage vidéo avec Windows Movie Maker</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><strong>Windows Movie Maker</strong> est un logiciel de montage vidéo fourni avec les systèmes d’exploitation Windows XP,  Vista , Windows 7 et Windows 8. il permet de créer des effets spéciaux, des transitions, d’ajouter des textes, des pistes son, <span lang="en" xml:lang="en"><em>timeline</em></span>, Auto Movie et des captures sonores. C’est un logiciel de montage vidéo pratique et simple.<br>
          Windows Movie Maker supporte nativement les formats vidéo WMV, MPEG, AVI, DVR-MS et ASF. En ce qui concerne les formats audio, celui-ci supporte le WMA, MP3, WAV, MIDI, AIFF et AU.<br>
          Concernant l'enregistrement des montages réalisés, il ne propose que les formats WMV ,WLMP et DV-AVI.<br>
          Il est facile de créer des vidéos grâce à ce logiciel. En effet, il suffit d'importer quelques images et de la musique puis d'assembler les vidéos en appliquant des effets ou des transitions choisis parmi les quelques dizaines qui sont proposées. On peut également ajouter des sous-titres ou une légende sur les images.</p>
          </td>
        <td width="175"><div align="right">
          <p><img src="images/Windows_Movie_Maker_icon.png" alt="windows movie maker" width="256" height="256"></p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
        </div></td>
      </tr>
