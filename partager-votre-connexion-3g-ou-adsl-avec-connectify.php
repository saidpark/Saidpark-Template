...
<title>Partager votre connexion 3g ou adsl avec connectify | Point d’accès Wifi</title>
<META name=title content="Partager votre connexion 3g ou adsl avec connectify | Point d’accès Wifi">
<meta name="description" content="Vous voulez partager votre connexion en Wifi avec plusieurs ordinateurs ? Dans ce tutoriel, vous allez apprendre comment transformer votre ordinateur en un point d’accès Wifi afin de partager n’importe quel type de connexion. Connectify vous permettra de transformer votre ordinateur Windows xp, Vista, Windows 7 ou Windows 8 en véritable point d'accès Wi-Fi" />
<meta name="keywords" content="3g, connectify, internet, partage, reseau, connexion, hotspot, partager, routeur, wifi, ad hoc," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97"><div class="fb-like" data-href="./partager-votre-connexion-3g-ou-adsl-avec-connectify.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
    <p align="center" class="Style14"><a href="./partager-votre-connexion-3g-ou-adsl-avec-connectify.php">Comment créer un point d’accès Wifi</a></p>
    <p align="center" class="Style12">Partager votre connexion 3g ou adsl avec connectify</p><br></td>
  </tr>
  <tr>
    ...
    <td rowspan="2"><table width="579" height="164" border="0">
      <tr>
        <th width="573" scope="col"><div align="left">
            ...
            <p class="Style6">Vous avez  une connexion 3G, ADSL ou connexion par câble ? Vous voulez la partager en Wifi avec plusieurs ordinateurs ? Dans ce tutoriel, vous allez apprendre comment transformer votre ordinateur en un point d’accès Wifi afin de partager n’importe quel type de connexion.<br>
              <strong class="Style5">Connectify</strong> vous permettra de transformer votre ordinateur Windows xp, Vista, Windows 7 ou Windows 8 en véritable point d'accès Wi-Fi. Contrairement au mode ad hoc, plusieurs ordinateurs pourront s'y connecter simultanément et vous n'aurez besoin que d'une seule carte Wi-Fi. Elle deviendra un hotspot internet Wi-Fi tout en restant connectée à Internet via un autre point d'accès.            </p>
            <p align="center" class="Style6"><img src="images/connectify.PNG" alt="connectify" width="307" height="335"></p>
            <h2 class="Style5">Téléchargement et installation de Connectify :</h2>
