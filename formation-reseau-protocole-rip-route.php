...
<title>Formation en réseau à la marocaine le protocole rip route | Cours réseau et télécommunication</title>
<META name=title content="Formation en réseau à la marocaine le protocole rip route | Cours réseau et télécommunication">

<META lang=fr name=description content="RIP v1 est considéré comme un protocole IGP, c'est un protocole à vecteur de distance qui diffuse intégralement sa table de routage à chaque routeur voisin, à intervalles prédéfinis. L’intervalle par défaut est de 30 secondes. RIP utilise le nombre de sauts comme métrique, avec une limite de 15 sauts maximum RIP v2 est une version améliorée de RIP v1. " />
<meta name="keywords" content="RIPv1 or RIPv2, How RIP routing works, RIP updates, RIP timer, Configure RIP Routing, RIP in CCNA,security,protocol,networks,internet,data,communication, RIP, Routing Information Protocol, RIP, RIP2, Routing Information Protocol, Routing Protocols, RIP (RIP2) overview, RIP (RIP2) structure, RIP (RIP2) format, RIPng, IGP, EGP, RFC 1058, RFC 2453, UDP, IP, IPv6" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./formation-reseau-protocole-rip-route.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./formation-reseau-protocole-rip-route.php">Formation réseau </a></p>
    <p align="center" class="Style12">Formation réseau à la marocaine le protocole rip route</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"> RIP v1 est un protocole à vecteur de distance qui diffuse intégralement sa table de routage à chaque routeur voisin, à intervalles prédéfinis. L’intervalle par défaut est de 30 secondes. RIP utilise le nombre de sauts comme métrique, avec une limite de 15 sauts maximum.</p>
          <p class="Style6">Si le routeur reçoit des informations concernant un réseau et que l’interface de réception appartient au même réseau mais se trouve sur un sous-réseau différent, le routeur applique le masque de sous-réseau configuré sur l’interface de réception</p>
          <p class="Style6">RIP v1 comporte les limitations suivantes:<br>
            • Il n’envoie pas d’informations sur les masques de sous-réseau dans ses mises à jour.<br>
            • Il envoie des mises à jour sous forme de broadcasts sur 255.255.255.255.<br>
            • Il ne prend pas l’authentification en charge.<br>
            • Il ne prend en charge ni VLSM, ni le routage CIDR (Classless Interdomain Routing).</p>
          <p class="Style6">RIP v2 est une version améliorée de RIP v1. Les deux protocoles partagent un certain nombre de caractéristiques:<br>
            • Il s’agit d’un protocole à vecteur de distance utilisant le nombre de sauts comme métrique.<br>
            • Il utilise des compteurs de retenue pour empêcher les boucles de routage (valeur par défaut: 180 secondes).<br>
            • Il utilise la règle «split horizon» pour empêcher les boucles de routage.<br>
            • Il utilise 16 sauts comme métrique de mesure infinie.</p></td>
        <td width="175"><p align="right"><img src="images/Services-network-cloud.jpg" alt="protocol rip" width="275" height="239"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
