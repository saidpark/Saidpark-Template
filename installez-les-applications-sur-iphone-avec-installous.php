...
<title>Installous - installez facilement les applications sur iPhone ! | iPhone 4S, iPhone 4, iPhone 3GS, iPhone 3G, iPhone 2G</title>
<META name=title content="Installous - installez facilement les applications sur iPhone ! | iPhone 4S, iPhone 4, iPhone 3GS, iPhone 3G, iPhone 2G">

<meta name="description" content="il est déjà possible d’installer soit même les applications iPhone au format .ipa sur votre iPhone jailbreaké ,Installous le fait pour vous ! Et ça marche…trés bien, Tout d’abord, il vous faut Installous. Pour cela...." />
<meta name="keywords" content="iPhone, iPod, iPad, Cydia, jailbreak, apple, hack, iPad2, firmware, IOS 4.3.2, IOS 4.3.1, IOS 4.3, IOS 4.2.1, IOS 4.3.3, winter board theme, iPod Touch, tuto, icy, redsn0wgre, jailbreak me, iPhone 4, the firmware, firmware, rock application, dev team, iTunes, windows, Mac, OSX, iphone, iPodTouch, thème,  application, ipodtouchisapro, logiciel, appstore, itunes,tutoriels" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./installez-les-applications-sur-iphone-avec-installous.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./installez-les-applications-sur-iphone-avec-installous.php">iPhone astuces </a> </p>
    <p align="center" class="Style12">[Tuto] Installous : installez facilement les applications sur iPhone!</p><br>    </td>
  </tr>
  <tr>
   <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="587" height="615" border="0">
      <tr>
        <th scope="col"><div align="left" class="Style10">
          <p class="Style6"><IMG title="iphone" border="0" alt="iphone" align="left" src="images/iphone4.bmp" width="95" height="135"></p>
          <p class="Style6">Il était déjà possible d’installer soit même les applications iPhone au   format .ipa sur votre iPhone jailbreaké, en passant par exemple via Diskaid.</p>
          <p class="Style6"><span class="Style6">Dorénavant, Installous le fait pour   vous ! Et ça marche…à peu près bien</span></p>
          <p class="Style6">Bien évidemment, vous devez avoir choisi les applications que vous   installerez grâce à cette méthode s’il s’agit, bien sûr, d’une application   iPhone. Il en va de votre responsabilité.</p>
          <p class="Style23"><STRONG>Tout d’abord, il vous faut Installous. Pour cela :</STRONG></p>
          <UL>
            <LI><span class="Style6">lancez Cydia   
            </span>
            <LI><span class="Style6">allez dans « Manage », puis sur « Edit », puis sur « Add »   
            </span>
            <LI><span class="Style6">ajoutez cette source : http://cydia.hackulo.us/  ou   http://cydia.install0us.com   
            </span>
            <LI class="Style6">validez </LI>
          </UL>
          <p class="Style23"><STRONG>Une fois la source ajoutée, il vous faut télécharger l’application   Installous :</STRONG></p>
          <UL>
            <LI><span class="Style6">toujours dans Cydia, allez dans Search   
            </span>
            <LI><span class="Style6">tapez Installous   
            </span>
            <LI class="Style6">téléchargez l’application </LI>
          </UL>
          <p class="Style6"><STRONG class="Style23">Ça y est, vous pouvez installer les applications au format   .ipa</STRONG></p>
          <p class="Style6">2 possibilités s’ouvrent à vous :</p>
          <UL>
            <LI class="Style6">Vous avez des fichiers .ipa sur votre ordinateur : </LI>
          </UL>
          <p class="Style6">Dans ce cas, lancez Diskaid, et mettez vos fichiers .ipa dans le répertoire   var\mobile\Library\Downloads</p>
          <p class="Style6">Vous n’avez plus qu’à lancer Installous, et à installer vos applications.</p>
          </div></th>
        </tr>
      ...
      <ul>
        <li class="Style6">Vous n’avez pas de fichiers .ipa : </li>
      </ul>
      <p class="Style6"><strong class="Style23">Appshare </strong>est fait pour vous ! Installez Appshare depuis   Cydia.</p>
      <p class="Style6">Appshare n’est ni plus ni moins qu’une application qui vous permettra de   télécharger et d’installer depuis l’iPhone une très grande partie des   applications de l’App Store.</p>
      <span class="Style6">Lancez Appshare, puis choisissez Appulo.us. Mobile. Choisissez ce qui vous   intéresse (affichage par ordre alphabétique, par ordre de fraîcheur…), puis   choisissez une application en cliquant dessus.<br>
    La fiche descriptive de l’application s’affiche. Allez tout en bas et cliquez   sur Download ( et prenez la dernière version de préférence). Vous aurez le choix   entre plusieurs sources de téléchargement (megaupload, sendspace, rapidshare…).   Prenez celle de votre choix, puis lancez le téléchargement. Là, vous aurez le   choix entre télécharger et installer l’application. Si vous télécharger   uniquement l’application, il vous faudra aller dans Installous pour l’installer,   si vous choisissez « Install », l’application sera téléchargée puis installée de   suite.</span></td>
  </tr>
  <tr>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td><p class="Style6">Une fois l’application installée, l’icone de l’application est sur le   springboard.</p>
      <p class="Style6">Lancez l’application, et amusez vous </p>
      <p class="Style6"><STRONG class="Style23">EDIT :</STRONG> Suite à une question de Yeyo, effectivement, les jeux   téléchargés via Appshare restent en mémoire après installation. Vous pouvez   supprimer le fichier .ipa soit :</p>
      <UL>
        <LI><span class="Style6">En allant dans le dossier var/mobile/Library/Downloads en utilisant DiskAid.   N’oubliez pas de choisir Root Folder en cliquant dans le menu déroulant, en bas   à gauche de la fenêtre de l’application
        </span>
        <LI class="Style6">Ou alors, si vous avez dTunes, vous pourrez supprimer directement depuis   elle les fichiers .ipa, puisque dTunes utilise le même dossier pour stocker les   mp3 ! Lancez dTunes, puis allez dans « Browse ». Vous voyez alors vos mp3 et vos   applications téléchargées. Cliquez sur Edit en haut à droite, et supprimez ce   dont vous ne voulez plus  On   ne peut faire plus simple ! </LI>
      </UL>
      <p align="center" class="Style23">Enfin, voici une vidéo résumant ce que vous devez faire :</p>
      
    <p align="center" class="Style6">Be Sociable,   Share!</p>    </td>
  </tr>
  <tr>
