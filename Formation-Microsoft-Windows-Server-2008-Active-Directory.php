...
<title>Formation Microsoft Windows Server 2008 Active Directory | Windows server</title>
<META name=title content="Formation Microsoft Windows Server 2008 Active Directory | Windows server">

<META lang=fr name=description content="Ce cours permet à des administrateurs de serveurs de la technologie Active Directory d’acquérir les connaissances et les compétences pour configurer les services de domaine Active Directory dans un environnement d’entreprise, sécuriser des domaines à l’aide de stratégies de groupe, à effectuer des sauvegardes et des restaurations ainsi qu’à contrôler et résoudre les problèmes de configuration Active Directory afin d’assurer un fonctionnement sans problème." />
<meta name="keywords" content="Cours Active Directory, annuaire Windows server, Microsoft, administration de système, active directory 2012,formation active directory,certification active directory, WINDOWS SERVER 2012,WINDOWS SERVER 2008, MCSA, MCTS, service d'annuaire, authentification, répertorie acrive directory, Windows Server 2003, Windows Server 2008 R2, SAM, stockage, ADDS, ADLDS, ADRMS, ADFS, ADCS, IDA,GPO,stratégie d'audit, reseau, kerberos" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Formation-Microsoft-Windows-Server-2008-Active-Directory.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Formation-Microsoft-Windows-Server-2008-Active-Directory.php">Cours Active Directory </a></p>
    <p align="center" class="Style12">Formation Microsoft Windows Server 2008 Active Directory</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><strong>Active Directory</strong> est un service d'annuaire utilisé pour stocker des informations relatives aux ressources réseau sur un domaine. Ce cours permet à des administrateurs de serveurs de la technologie <strong>Active Directory</strong> d’acquérir les connaissances et les compétences pour configurer les services de domaine Active Directory dans un environnement d’entreprise, sécuriser des domaines à l’aide de stratégies de groupe, à effectuer des sauvegardes et des restaurations ainsi qu’à contrôler et résoudre les problèmes de configuration Active Directory afin d’assurer un fonctionnement sans problème.<br>
            </p>
          </td>
        <td width="175"><div align="right"><img src="images/active-directory.jpg" alt="active directory" width="256" height="123"></div></td>
      </tr>
    </table>    
    <p align="left" class="Style6"><span class="Style12">Partie 1 : Présentation des services de domaine Active Directory</span></p>
    <p align="center" class="Style6">
     
    <p align="left" class="Style12">Partie 2 : Administration sécurisée et configuration d'Active Directory</p>
   </td>
  </tr>
  <tr>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td><p class="Style23"><span class="Style12">Partie 3 : Administration  de domaine des services d'annuaire Active Directory</span>
