...
<title>Savoir qui t'a supprimé de facebook - Facebook astuces</title>
<META name=title content="Savoir qui t'a supprimé de facebook - Facebook astuces">

<meta name="description" content="Trouve celui qui t'a bloqué ou supprimé de facebook , ça marche 100% il s'agit d'un add-on qui va checker automatiquement de manière transparente et invisible à chaque ouverture de facebook si votre liste d'amis a diminué soit parce que vous avez enlevé un ami, soit parce qu'un ami vous a retiré de sa liste. Donc, à partir du moment où vous l'avez installé, vous serez automatiquement notifié quand vous perdrez un ami!." />
<meta name="keywords" content="tutoriel, facebook, facebook friend checker, liste d'amis, livre facebook, guide officiel, manuel, vie privée, recherche personne" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    ...
    <p align="center" class="Style12"> <a href="./Facebook-astuces-savoir-qui-ta-supprime-de-facebook.php">Trucs et astuces Facebook </a> </p>
    <p align="center" class="Style9">Comment savoir si un ami Facebook vous a retiré de sa liste ? </p><br></td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="579" height="164" border="0">
      <tr>
        <th width="394" height="137" scope="col"><div align="left" class="Style10">
          <p class="Style4"><div class="fb-like" data-href="./Facebook-astuces-savoir-qui-ta-supprime-de-facebook.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
          <p class="Style11">Voici une astuce pour savoir si un de vos &quot;amis&quot; facebook vous a retiré de sa liste d'amis ! Comment ça marche? il s'agit d'un &quot;add-on&quot; qui va checker automatiquement de manière transparente et invisible (à chaque ouverture de facebook) si votre liste d'amis a diminué (soit parce que vous avez enlevé un ami, soit parce qu'un ami vous a retiré de sa liste). Donc, à partir du moment où vous l'avez installé, vous serez automatiquement notifié quand vous perdrez un ami ! </p>
          <p> </p>
          <p align="center"><img src="images/tuto[1].jpg" width="114" height="30" border="0"></p>
        </div></th>
        <th width="175" scope="col"><div align="right"><a href="./Facebook-astuces-savoir-qui-ta-supprime-de-facebook.php"><img src="images/3162042.jpg" alt="facebook" width="166" height="143" border="0"></a></div></th>
      </tr>
      <tr>
