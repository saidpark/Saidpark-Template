...
<title>Cours linux en dialecte marocain pour débutant et professionnel</title>
<META name=title content="Cours linux en dialecte marocain pour débutant et professionnel">

<META lang=fr name=description content="Voici des cours en linux pour débutant ou profesionnel en dialecte marocain (Darija) alors profitez en, l'informatique et l'échange de savoir vous intéresse? Cet espace est fait pour vous." />
<meta name="keywords" content="ubuntu desktop, install ubuntu, linux ubuntu, ubuntu alternate, installation ubuntu, ubuntu livecd, ubuntu iso, ubuntu, ubuntu kernel, ubuntu live cd, ubuntu packages, ubuntu computer, ubuntu training, ubuntu software, ubuntu pdf, ubuntu course, download ubuntu, rar ubuntu, ubuntu root password, ubuntu games, ubuntu netbook, portable ubuntu, ubuntu forums, ubuntu ultimate" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./cours-linux-pour-debutant-et-professionnel.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./cours-linux-pour-debutant-et-professionnel.php">Formation en linux </a></p>
    <p align="center" class="Style12">Cours linux pour débutant et professionnel</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Cette formation donnera une description et des exemples d’utilisations des commandes de base les plus courantes sous Linux.</p>
          <p class="Style6">Les cours sont classées en 3 grandes parties :</p>
          <p class="Style6">Réalisé par le professeur faissal </p></td>
        <td width="175"><div align="right"><img src="images/Tux.svg.png" alt="linux" width="178" height="199"></div></td>
      </tr>
    </table>    
    <p align="left" class="Style6"><span class="Style12">Partie 1: Cours d'installation et administration de linux</span><br>
    </p>
   
    <p align="left" class="Style12">Partie 2 : Les commande de base sous Linux </p>
   </td>
  </tr>
  <tr>
