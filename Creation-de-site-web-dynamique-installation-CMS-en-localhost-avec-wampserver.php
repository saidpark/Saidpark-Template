...
<title>Création de site web dynamique et installation de CMS en localhost | WampServer</title>
<META name=title content="Création de site web dynamique et installation de CMS en localhost | WampServer">

<META lang=fr name=description content="Nous découvrons dans ce cours comment installer et gérer un CMS Open Source en local avec Wampserver pour réaliser un sites web dynamique profesionnel. en utilisant les différents langages HTML5, CSS, XML, PHP, JavaScript et les bases de données." />
<meta name="keywords" content="sites web dynamique, CMS, HTML5, CSS, XML, PHP, JavaScript, les bases de données, data base, administrer site web, siteweb, les liens internes, lien extérne, insérer image, insérer video, wordpress, cms wordpress gratuit, cms gratuit, free cms, Wampserver, localhost, référencement seo, SEO, E-Commerce, installer cms, xml, Nom de domaine, webmaster, serveur Apache, template gratuit, free template, théme wordpress, cms joomla, " />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Creation-de-site-web-dynamique-installation-CMS-en-localhost-avec-wampserver.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Creation-de-site-web-dynamique-installation-CMS-en-localhost-avec-wampserver.php">Créer un Site Web dynamique (CMS) </a></p>
    <p align="center" class="Style12">Création de site web dynamique  CMS en localhost avec WampServer</p>
    <br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="587" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><strong>Introduction: </strong>Nous découvrons dans ce cours comment installer et gérer un CMS Open Source en local avec Wampserver pour réaliser un sites web dynamique profesionnel. en utilisant les différents langages HTML5, CSS, XML, PHP, JavaScript et les bases de données. </p>
          <p class="Style6"><strong>L'objectif de la Formation</strong>:</p>
          <p class="Style6">Cette formation est exclusivement  destiné aux débutants et professionels, Vous permettra de prendre en main le fonctionnement des CMS, de découvrir les<br>
            phases de la réalisation d’un site Web dynamique et atractif. Vous allez apprendre également à rédiger vos articles, personnaliser votre site et intégrer des images.</p>
          <p class="Style6"><strong>Le Contenu de la Formation:</strong></p>
          <p class="Style6"><span class="Style6">
            </span><span class="Style25">Module 1</span><span class="Style6">: Personnaliser votre thème menu et widgets
              <br>
              </span><span class="Style25">Module 2</span><span class="Style6">: Modifier le contenu de votre site web<br>
              </span><span class="Style25">Module 3</span><span class="Style6">: insérer les images et des videos<br>
              </span><span class="Style25">Module 4</span><span class="Style6">: Ajouter des liens internes et extérne<br>
              </span><span class="Style25">Module 5</span><span class="Style6">: Effectuer des mises à jour pour votre site</span></p>
          <p class="Style6"><strong>Public cible: </strong>webmaster débutant et tout professionnel souhaitant être présent et communiquer sur le Web.</p>
          <p class="Style6"><strong>Pré-requis:</strong> connaître les différents langages  HTML, CSS, PHP, JavaScript.</p></td>
        <td width="175"><p align="right"><img src="images/site-web-dynamique.png" alt="création site web CMS" width="224" height="216"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
      ...
      <p class="Style12">Partie 1: Création de site web dynamique  CMS en localhost | WampServer</p>
     </td>
  </tr>
  <tr>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td><p align="left" class="Style12">Partie 3 : Personnaliser votre CMS menu et widgets    
