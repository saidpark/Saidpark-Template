...
<title>(Cydia) Les meilleures applications cydia pour iPhone 4s : Applications Cydia, Icy, Package</title>
<META name=title content="(Cydia) Les meilleures applications cydia pour iPhone 4s : Applications Cydia, Icy, Package">
<meta name="description" content="Bonjour à tous, Vous venez de jailbreaker votre iphone 4s ou votre ipad 2 en ios 5.0.1 mais voilà vous ne connaissez pas encore ce ...Voici une sélection de plus de 100 applications gratuites pour votre iPhone. Chacune d'entre-elles a été sélectionnée en raison de son utilité et de son..." />
<meta name="keywords" content="cydia, applications, pour, les, meilleures, activation, idevice, tinyumbrella, home, boot, appel, permanence, batterie, question, apple, applications gratuite, iphone, mobile, iPhone, iPod, iPad, Cydia, jailbreak, apple, hack, iPad2, firmware, IOS 4.3.2, IOS 4.3.1, IOS 4.3, IOS 4.2.1, IOS 4.3.3, winter board theme, iPod Touch, tuto, icy, redsn0wgre, jailbreak me, iPhone 4, the firmware, firmware, rock application, dev team, iTunes, windows, Mac, OSX, iphone, iPodTouch, thème, application, ipodtouchisapro, logiciel, appstore, itunes,tutoriels" />
...
.Style21 {color: #006699; font-size: 15px;}
-->
</style>
...
<table width="922" height="907" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
    <TBODY>
      ...
      alt="Remember Me" value=yes name=remember> <span class="Style20">
          <LABEL 
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    ...
    <p align="center" class="Style14"><a href="./cydia-les-meilleures-applications-pour-iPhone-4s.php">iPhone astuces </a> </p>
    <p align="center" class="Style12">(Cydia)Les meilleures applications cydia pour iPhone 4s</p><br></td>
  </tr>
  <tr>
    ...
    <td rowspan="2"><table width="587" height="164" border="0">
      <tr>
        <th scope="col"><div align="left" class="Style10">
          ...
          <div class="fb-like" data-href="./cydia-les-meilleures-applications-pour-iPhone-4s.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
          
          <p class="Style6">Vous venez de jailbreaker votre iphone 4s ou votre ipad 2 en ios 5.0.1 mais   voilà vous ne connaissez pas encore ce que vous pouvez installer.Je vous ai   recensé,à mon sens,le top des tweaks capables de modifier votre idevice   préféré,et surtout à quoi ça sert  :<BR>
            <BR>
            <BR>
            -Ishshit(sauvegardez vos shsh depuis votre idevice,excellent   complément à tinyumbrella)<BR>
            -Open ssh/ssl(indispensable pour communiquer avec   l'iphone via winscp)<BR>
            -Sbsettings(ajout de commandes et fonctions via la barre   de statut et centre de notification)<BR>
            -Winterboard(activation de thèmes et   modifications graphiques)<BR>
            -Ifile(rentrez au coeur de l'idevice pour modifier   ce que vous voulez,avec prudence  )<BR>
            -Killbackground(fermez toutes vos applications dans le mutitache en un   clic)<BR>
            -Update hider(masquez les mises à jour de   l'appstore)<BR>
            -Adblocker(plus de publicités nuisibles)<BR>
            -Homepage in   safari(assigner une page d'accueil à votre navigateur)<BR>
            -Iblacklist(un excellent filtre pour appels indésirables)<BR>
            -Mywi 5(partagez la   connection internet de votre iphone)<BR>
            -3g unrestrictor 5(levez la restriction   wifi et tuliser facetime à l'extérieur par exemple)<BR>
            -Copic(affiche les photos   de vos contacts)<BR>
            -Gridlock(placez vos icones ou vous voulez)<BR>
            -Icon   renamer(renommer vos applications)<BR>
            -Folder enhancer(modification des   dossiers,nombre d'icones..)<BR>
            -Barrel(effet vidéo sur votre springboard de   pages en pages,attention n'est pas compatible avec intelliscreenx)<BR>
            -Round   corners(arrondissez les angles de votre écran)<BR>
            -Black keyboard(votre clavier   devient noir)<BR>
            -Icon harvester+thèmes(modifiez le thème de votre iphone et une multitude de   thèmes gratuits)<BR>
            -Power alerter(gestion et alertes pour votre   batterie)<BR>
            -Stayopened(l'appstore reste ouvert en téléchargeant une   application)<BR>
            -Appbackup(sauvegardez vos applications,niveaux de   jeux..)<BR>
            -Clean up(un ccleaner pour iphone)<BR>
            -Pkgbackup(sauvegarde de vos   applications cydia installées)<BR>
            -Xbackup(sauvegarde des applications cydia installées)
            <BR>
            <BR>
          </p>
          </div></th>
      ...
      <span class="Style6">-Homescreen settings(assignez un racourci quelconque sur votre   springboard)<br>
-Manualcorrect pro(correction et aide à   l'orthographe)<br>
-Radars france tomtom addon(les radars fixes et mobiles dans   tomtotm)<br>
-Springtomize 2(véritable couteau suisse en customisation,change   l'opérateur,le lockscreen...)<br>
-Masks(mettez un masque sur votre wallpaper et   modifier les effets d'icones)<br>
-Bitesms(client sms puissant remplaçant celui   de l'ios)<br>
-Iconlock(bloquez pour de bon l'emplacement de vos   icones)<br>
-Protube (modification de l'application native youtube,téléchargement   de vidéos...)<br>
-Locklauncher(lancez vos applications préférées depuis le   lockscreen)<br>
-Unlockfx(effet vidéos pour dévérouillez)<br></span><span class="Style6">-Sbbrightness   buttons(assigne des boutons sur le springboard pour gérer la   luminosité)<br>
-Firebreak(activez le mode panorama pour les photos sur iphone   4s)<br>
-Handsfree control:(siri vous écoute en permanence sans avoir besoin du   bouton home)<br>
-My assistant(ajout de commandes à siri,lancer des applications   vocalement,créer des questions et réponses personnalisées)<br></span><span class="Style6">-Weeslide for   notification center(gérez le volume,la luminosité et le wifi depuis le centre de   notifications)
      -Anyring(créez vos   sonneries d'appel et de sms)<br>
-Wifi booster(voyez autour de vous les points   wifi protégés et gratuits)<br>
-Animatefix ios 5:changer le boot logo de votre   idevice</span></td>
  </tr>
  <tr>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td><span class="Style6">-Powerpro center(+plugins):customisez votre centre de   notifications)<BR>
      -Intelliscreenx(vos notifiactions et centre de notifications   sur le lockscreen)<BR>
      -No update(désactive les mises à jour de   l'ios)<BR>
      -Airblue sharing:active le bluetooth vers tous les appareils   équipés<BR>
      -Zeppelin:logo customisé pour votre opérateur<BR>
        <BR>
        En attente de   compatibilité:<BR>
        <BR>
        -Iphonedelivery 5(les accusés de reception pour   iphone)<BR>
        -Celeste(un bluetooth compatible avec tous les autres   appareils)<BR>
        <BR>
                Et voilà le travail après jailbreak  :</span><BR>
        <BR>
        <img src="images/263925photo1.png" alt="iphone app" width="426" height="640"></p>
      <p><img src="images/572427photo.png" alt="iphone app" width="426" height="640"></p>
    <p class="Style6">Alors n'hesitez pas à poser vos questions sur notre page Facebook </p>
    </td>
  </tr>
  <tr>
