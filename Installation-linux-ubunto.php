...
<title>Linux - installation de la distribution Ubunto - Formation vidéo</title>
<META name=title content="Linux - installation de la distribution Ubunto - Formation vidéo">

<meta name="description" content="Ubuntu 8.04 LTS Desktop Edition est arrivé sur le marché le 24 avril 2008. En plus d'adopter les dernières versions des logiciels open source les plus populaires (dont Firefox 3 beta 5), cette distribution Linux sera supportée pendant trois années (LTS signifie Long Term Support). Les utilisateurs souhaitant coller à l'actualité pourront cependant passer à l'Ubuntu 8.10, dès octobre 2008." />


<meta name="keywords" content="ubuntu desktop, install ubuntu, linux ubuntu, ubuntu alternate, installation ubuntu, ubuntu livecd, ubuntu iso, ubuntu, ubuntu kernel, ubuntu live cd, ubuntu packages, ubuntu computer, ubuntu training, ubuntu software, ubuntu pdf, ubuntu course, download ubuntu, rar ubuntu, ubuntu root password, ubuntu games, ubuntu netbook, portable ubuntu, ubuntu forums, ubuntu ultimate, livecd, Cour vidéo, tutorial vidéo, formation vidéo, formation graphique, tutoriel vidéo, Maroc vidéo, vidéo Maroc, formation Maroc, cour logiciel, apprendre graphisme," />
...
<table width="923" height="150" border="0" align="center">
  <tr>
    <th width="774" scope="col"><div align="left"><img src="images/myfont.png" width="752" height="171" border="0">
...
<table width="922" height="892" border="0" align="center" bgcolor="#FFFFFF">
  <tr>
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97"><p align="right" class="Style5">&nbsp;</p>
      <blockquote>
        <p align="center" class="Style9"><span class="Style5"><a href="./Installation-linux-ubunto.php">Formation en  LINUX</a> </span></p>
      </blockquote>      
    <p align="center" class="Style5"><span class="Style12">Installation de la distribution UBUNTU sur Windows </span></p><br></td>
  </tr>
  <tr>
    <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4"><table width="552" height="218" border="0" align="center">
      <tr>
        <th width="375" height="157" scope="col"><p><div class="fb-like" data-href="./Installation-linux-ubunto.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div></p>
        <DIV align="justify" class="Style11">
            <p>L'Ubuntu 8.04 LTS Desktop Edition est arrivé sur le marché le 24 avril 2008. En plus d'adopter les dernières versions des logiciels &quot;open source&quot; les plus populaires (dont Firefox 3 beta 5), cette distribution Linux sera supportée pendant trois années (LTS signifie Long Term Support). Les utilisateurs souhaitant coller à l'actualité pourront cependant passer à l'Ubuntu 8.10, dès octobre 2008.</p>
            <p>&nbsp;</p>
            <p align="right"><a href="http://www.ubuntu.com/download/desktop" target="_blank"></a> </p>
          </DIV></th>
        <th width="167" scope="col"><div align="right"><a href="./Installation-linux-ubunto.php"><img src="images/ubuntu8.png" alt="linux ubunto" width="148" height="135" border="0"></a></div></th>
      </tr>
      <tr>
  ...
  <tr>
    <td colspan="2" bgcolor="#10315A"><div align="right" class="Style6">
     <div align="right"><font color="#FFFFFF" face="Verdana"></font>
       <div align="right"><font color="#FFFFFF" face="Verdana">  Copyright  - 2014<strong>  <a href="http://saidpark.free.fr"  style="color:#cccccc";>saidpark</a>  Tous droits réservés.
       </strong></font></div>
     </div>
    </div></td>
  </tr>
