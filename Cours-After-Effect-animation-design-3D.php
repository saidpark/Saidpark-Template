...
<title>Cours After Effects - Créer une carte du monde 3D - Design 3D</title>
<META name=title content="Cours After Effects - Créer une carte du monde 3D - Design 3D">

<meta name="description" content="Cours et Formation after effects étape par étape : comment utiliser After Effects la création d'une carte du monde 3D, à l'aide du logiciel after effects après un découpage des photos avec photoshop , After Effect est un logiciel dédié au compositing. Il permet donc de créer des animations et effets spéciaux pour de la vidéo.. . Historique. C'est à la fin des années 80 que Dave Herbstman, Dave Simmons et Dan Wilk, fondateurs de la société CoSA (pour Company of Science and Art), débutent le développement de Egg, un soft d'animation pour le cinéma et la télévision. C'est en Janvier 1993, dans le cadre du MacWorld de Boston, qu'ils présentent le fruit de leur travail, devenu After Effect. Grâce à ses avantages (moins cher, résolution variable, etc), c'est un succès immédiat. Fort de cette réussite, After Effect est rapidement revendu à Aldus Corporation qui le cède à son tour à Adobe. S'en suit un développement très calme (4 ans entre les v 3 et v4) puis une accélération à partir de 2001 avec la sortie d'une nouvelle version tous les 2 ans. After Effect adopte alors le même rythme d’évolution que Photoshop qu'il rejoint en 2003 avec la création par Adobe de la Créative Suite. . . Description du Logiciel. Grâce à un système de superposition de calque (même principe que Photoshop), After Effect permet de rassembler plusieurs sources, qu'elles soient vidéo ou photo, dans une même composition. Ensuite, en attribuant différents paramètres (forme, timing, déplacement, taille, couleurs, opacité, etc) à chacun de ces médias, l'animation prend forme. . . After Effect permet notamment de créer une transition entre 2 sources, de mettre en place un tracking automatique, d'animer une texture ou une typographie ou plus encore des effets spéciaux comme une explosion ou l'évaporation d'un personnage.. . A noter qu'After Effect fonctionne sur le principe des fichiers non destructifs. Cela signifie qu'il ne travaille pas directement avec le fichier source (quand il y en a un) mais avec une extraction de celui-ci. Il est donc possible de vérifier une animation image par image mais il est impossible de visualiser en temps réel une vidéo comme dans un logiciel de montage classique. Pour cela, il est nécessaire de passer par une phase de calcul dont la durée dépend tout autant des ressources de la station utilisée que de la complexité des effets réalisés.. . . Plateformes compatibles. 100% compatible Mac OS et Windows. . . Plusieurs versions sont déjà sorties, dont la plus connue et la plus récente : Adobe After effects CS5. . La prochaine version de after effects s'appellera After Effects CS6" />
<meta name="keywords" content="cours after effect, adobe after effect, formation adobe after effect, after effect maroc, carte 3d avec after effect, carte du monde en 3d, carte du monde 3d after effect, arab after effect, tutorial arab after effect" />
...
.Style32 {font-family: Arial, Helvetica, sans-serif; color: #335566;}
...
<table width="923" height="150" border="0" align="center">
  <tr>
    <th width="823" scope="col"><div align="left"><img src="images/myfont.png" width="752" height="171" border="0">
...
<table width="919" height="822" align="center" bgcolor="#FFFFFF" bordercolor="#CCCCCC">
  <tr>
  ...
  <H3 align="center"><img src="images/images544.jpg" width="40" height="40"> <em>Identification</em></H3>
    ...
    <th width="583" scope="col"><div align="right"><img src="images/maroc informatique.gif" width="542" height="21"></div>
       <div align="right" bgcolor="#ffffff">
       <img src="images/bann.gif">      </div>
      <div align="right"><img src="images/presantation.gif" width="542" height="21"></div></th>
    <th width="160" rowspan="4" scope="col" bgcolor="#FFFFFF" bordercolor="#FFFFFF"><div id="pub">
  <p><div class="fb-like-box" data-href="https://www.facebook.com/" data-width="160" data-height="400" data-show-faces="true" data-stream="false" data-show-border="true" data-header="true"></div></p></div></th>
  </tr>
  <tr>
    <td height="93"><p align="center" class="Style32"><a href="./Cours-After-Effect-animation-design-3D.php">Cours After Effect </a></p>
      <p align="center" class="Style9">After Effect: Créer une carte du monde 3D</p></td>
  </tr>
  <tr>
    <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4" class="Style12"><table width="552" height="194" border="0" align="center">
      <tr>
        <th width="358" height="137" class="Style13" scope="col"><p align="left"><div class="fb-like" data-href="./Cours-After-Effect-animation-design-3D.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div></p>
          <p align="left">C'est ma première participation dans le site avec un cours de création d'une carte du monde 3D, à l'aide du logiciel &quot;after effect&quot; après un découpage des photos avec photoshop.</p>
          <p align="left">&nbsp;</p>
          </th>
        <th width="184" scope="col"><div align="right"><a href="./Cours-After-Effect-animation-design-3D.php"><img src="images/After-Effects.png" alt="cours after effect" width="150" height="150" border="0"></a></div></th>
      </tr>
      <tr>
        <td height="24"><div align="center"><img src="images/tuto[1].jpg" width="114" height="30" border="0"></div></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="25" colspan="2"><div align="left"></td>
        </tr>
    </table><br>
...
<h3 class="headerbar">Visiteurs</h3></td>
    <td rowspan="3" class="Style12" bgcolor="#FFFFFF" bordercolor="#FFFFFF">&nbsp;</td>
  </tr>
  <tr>
    <td height="128" class="Style5"><div align="center">Qui est en ligne ? </div>
        <p align="center">
  ...
  <tr>
    <td colspan="2" bgcolor="#10315A" class="Style19"><div align="right"><font color="#FFFFFF" face="Verdana"></font>
...
<p align="center" class="Style12"><img src="images/bande_partenaires[1].gif" width="612" height="22"></p>
