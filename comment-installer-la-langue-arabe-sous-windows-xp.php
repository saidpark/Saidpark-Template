...
<title>Comment installer la langue arabe sous Windows XP ? - Formation vidéo</title>
<META name=title content="Comment installer la langue arabe sous Windows XP ? - Formation vidéo">

<meta name="description" content="Voilà la méthode pour installer la langue arabe sous windows Xp, pour pouvoir lire et écrire l´arabe ,ainsi que l´utilisation des programmes en arabe. Mais pour réaliser ceci, il faut avoir le CD de WinXp, sinon vous ne pouvez pas installer les fichiers systèmes, un redémarage est nécessaire pouur compléter l´installation." />
<meta name="keywords" content="installer la langue arabe sous windows Xp, installer les fichiers systèmes, arabe, cours arabe, Cour vidéo, tutorial vidéo, formation vidéo, formation graphique, tutoriel vidéo, Maroc vidéo, vidéo Maroc, formation Maroc, cour logiciel, apprendre graphisme" />
...
<table width="919" height="822" align="center" bgcolor="#FFFFFF" bordercolor="#CCCCCC">
  ...
  <H3 align="center"><img src="images/images544.jpg" width="40" height="40"> <em>Identification</em></H3>
      ...
      alt="Remember Me" value=yes name=remember>
                            <label 
      for=mod_login_remember><em><strong>Se souvenir de moi</strong> </em></label>
                            <br>
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="93"><p align="center" class="Style9"><a href="./comment-installer-la-langue-arabe-sous-windows-xp.php">Installation et personnalisation</a> </p>
      <p align="center" class="Style9">Comment installer la langue arabe sous Windows XP? </p></td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4" class="Style12"><table width="552" height="194" border="0" align="center">
      <tr>
        <th width="372" height="137" class="Style13" scope="col"><p align="left"><div class="fb-like" data-href="./comment-installer-la-langue-arabe-sous-windows-xp.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div></p>
          <p align="left">Voilà la méthode pour installer la langue arabe sous windows Xp, pour pouvoir lire et écrire l´arabe ,ainsi que l´utilisation des programmes en arabe. Mais pour réaliser ceci, il faut avoir le CD de WinXp, sinon vous ne pouvez pas installer les fichiers systèmes, un redémarage est nécessaire pouur compléter l´installation.</p>
          <p align="left">Si vous n'avez pas le cd Windows xp, télécharger les fichiers nécessaires</p>
          </th>
        <th width="170" scope="col"><div align="right"><a href="./comment-installer-la-langue-arabe-sous-windows-xp.php"><img src="images/cour1.jpg" alt="installer langue arabe sur windows XP" width="150" height="170" border="0"></a></div></th>
      </tr>
      <tr>
        <td height="24"></td>
        <td>&nbsp;</td>
...
<br> <div class="roknewspager-wrapper">
		...
		<li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="Style6">L’entretien d'embauche a pour but de vérifier en quoi et comment les compétences du candidat sont à même de répondre au poste à pourvoir...</div>												
		...
		<li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="Style6">Voici comment installer windows 7 depuis une Clé USB. Utile pour les minis PC dépourvus de lecteur optique.</div>												
                                <div class="published-date">15 Février   2013</div>	            	            
		   ...
		   <li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="Style6">Ce cours a pour but de vous expliquer plus ou moins en détail comment configurer un routeur Cisco pour des réseaux locaux et des petits réseaux d'entreprise.</div>												
		   ...
		   <li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="Style6">Voici des cours d'électronique numérique pour débutant ou profesionnel en dialecte marocain (Darija) alors profitez en..</div>												
                                <div class="published-date">14 Février 2013</div>	            	            
		   ...
		   <li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="Style6">Cette formation donnera une description et des exemples d’utilisations des commandes de base les plus courantes sous Linux réalisé par le professeur faissal</div>												
		 ...
		 <li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="Style6">Voilà enfin après de longues heures d’attente, le jailbreak Evasi0n ios 6 pour votre iphone est finalement disponible!  rien que quelques cliques et le tour est joué...</div>												
                                <div class="published-date">13 Février 2013</div>	            	            
		   ...
		   <li>
	        <div class="roknewspager-div">
	            	            <a href="./controler-son-ordinateur-a-distance-depuis-un-smartphone-android.php" class="roknewspager-title">Contrôler son pc depuis son smartphone | Application Android</a>				
	            	            <div class="Style6">Les meilleures applications pour contrôler son pc depuis sa tablette ou son smartphone Android...</div>												
                                <div class="published-date">12 Février 2013</div>	            	            
	        ...
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="Style6">Découvrez le monde de la TV en ligne grâce à XBMC. Vous obtiendrez plus de 8000 chaînes (films, musique, vidéo clip, émissions, informations, sports…</div>												
                                <div class="published-date">12 Février  2013</div>	            	            
