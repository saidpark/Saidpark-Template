...
<title>Cours video de programmation Visual Basic.Net en dialecte marocain | Programmation</title>
<META name=title content="Cours video de programmation Visual Basic.Net en dialecte marocain | Programmation">
<META lang=fr name=description content="Ce cours a pour but de vous donner une idée général sur la programmation en Visual Basic.Net. il est important de rappeler que tout programme VB.NET est compilé dans le même langage intermédiaire que C# ou tout autre langage de la plateforme DotNet. La connexion aux bases de données est facilitée par l'amélioration des outils de glisser-déposer et l'utilisation de la dernière technologie ADO, ADO.NET." />
<meta name="keywords" content="code visual basic, msgbox visual basic, visual basic source, application visual basic, listbox visual basic, textbox visual basic, microsoft visual basic, visual basic access, visual basic 6, msdn visual basic, visual basic runtime, visual basic, visual basic 6.0, visual basic 2005, download visual basic, visual basic edition, visual basic free, book visual basic, ms visual basic, form visual basic, visual basic pdf, using visual basic, with visual basic, tutorial visual basic 6, programming with visual basic, download microsoft visual basic, microsoft visual basic 6, visual basic professional, learn visual basic 6, visual basic 6 full, visual basic pro, ocx visual basic, visual basic editor, visual basic 2003, visual basic for application, visual basic for applications, livre visual basic, visual basic.net, vb database, microsoft visual basic .net," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Cours-video-en-programmation-avec-Visual-Basic-.Net.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Cours-video-en-programmation-avec-Visual-Basic-.Net.php">Formation en programmation </a></p>
    <p align="center" class="Style12">Cours video en programmation avec Visual Basic .Net</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Ce cours a pour but de vous donner une idée général sur la programmation en <strong>Visual Basic .Net</strong><br>
          Il est important de rappeler que tout programme VB.NET est compilé dans le même langage intermédiaire que C# ou tout autre langage de la plateforme DotNet.<br>La connexion aux bases de données est facilitée par l'amélioration des outils de glisser-déposer et l'utilisation de la dernière technologie ADO, ADO.NET.<br>
        </p>
          </td>
        <td width="175"><div align="right"><img src="images/net_logo_2.jpg" alt="visual basic .net" width="253" height="166"></div></td>
      </tr>
    </table>    
    <p align="left" class="Style6"><span class="Style12">Partie 1 : introduction : Hello World en VB.NET</span></p>
    <p align="center" class="Style6">
      
    <p align="left" class="Style12">Partie 2 : Les Boucles et conditions</p>
    </td>
  </tr>
  <tr>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td><p class="Style23"><span class="Style12">Partie 3 : Les tableaux en VB .Net </span>
