...
.Style11 {font-size: 16px; color: #FF0000; font-weight: bold; }
...
.Style15 {color: #333333; font-size: 15px;}
-->
</style>
...
<table width="923" height="150" border="0" align="center">
  <tr>
    <th width="763" scope="col"><div align="left"><img src="images/myfont.png" width="752" height="171">
...
<table width="919" height="892" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
    <TBODY>
      ...
      alt="Remember Me" value=yes name=remember> <strong>
          <LABEL 
      for=mod_login_remember><em>Se souvenir de moi</em> </LABEL>
          </strong>
          <LABEL 
    ...
    <th width="160" rowspan="3" scope="col" bgcolor="#FFFFFF" bordercolor="#FFFFFF">
	<div id="pub">
  ...
  <tr>
    <td height="97"><p align="left" class="Style25">Pour devenir membre et béneficier pleinement de tous les services tel que la diffusion de vos tutorials et participation au partenariat,vous devez remplir le formulaire suivant.Attention, les champs marqués d'une astérisque <span class="Style13">*</span> sont obligatoires. </p><br><br>
      <hr width="522"></td>
  </tr>
  <tr>
    <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
    ...
    <form method='post' action='signup.php?do=check'>
	  
	  <table align="center">
        <tr>
          <td height="28">Nom:<span class="Style11">*</span></td>
          <td><label>
            <input name="nom" type="text" id="nom">
          </label></td>
        </tr>
        <tr>
          <td>Pr&eacute;nom:<span class="Style11">*</span></td>
          <td><label>
            <input name="prenom" type="text" id="prenom">
          </label></td>
        </tr>
        <tr>
          <td>E-mail:<span class="Style11">*</span></td>
          <td><label>
            <input name="Email" type="text" id="Email">
          </label></td>
        </tr>
        <tr>
          <td>username:<span class="Style11">*</span></td>
          <td><input type='text' name='username'></td>
        </tr>
        <tr>
          <td>password:<span class="Style11">*</span></td>
          <td><input type='password' name='password'></td>
        </tr>
  <tr>
    <td>confirm password<span class="Style11">*</span></td>
