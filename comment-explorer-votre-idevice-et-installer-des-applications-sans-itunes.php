...
<title>[Tuto] Explorer votre iDevice et installer des applications sans Itunes | iPhone 5, iPhone 4S, iPhone 4, iPhone 3GS, iPhone 3G</title>
<META name=title content="[Tuto] Explorer votre iDevice et installer des applications sans Itunes | iPhone 5, iPhone 4S, iPhone 4, iPhone 3GS, iPhone 3G">

<META lang=fr name=description content="Vous avez un Ipad, Iphone ou Ipod ? iTunes & Appstore vous font chier et vous en avez ras le bol ? Ne vous inquiétez pas, lisez cet article pour savoir comment installer des applications sans Itunes." />
<meta name="keywords" content="iPhone 4S, iPhone 4, iPhone 3GS, iPhone 3G, itunes, apps, installer les applications iphone, iphone sans itunes" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./comment-explorer-votre-idevice-et-installer-des-applications-sans-itunes.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./comment-explorer-votre-idevice-et-installer-des-applications-sans-itunes.php">iPhone astuces</a> </p>
    <p align="center" class="Style12">[Tuto]  Explorer votre iDevice et installer des applications sans Itunes</p><br>    </td>
  </tr>
  <tr>
   <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><p class="Style6">Vous avez un Ipad, Iphone ou Ipod ? iTunes &amp; Appstore vous font chier et vous en avez ras le bol ? Ne vous inquiétez pas, lisez cet article pour savoir comment y remédier.</p>
      <p class="Style23">NB :</p>
      <BLOCKQUOTE>
        <p><span class="Style27"> <STRONG>→</STRONG> Pour les iOS Non Jailbreakés, ce tutorial ne vous   concerne pas.</span></p>
      </BLOCKQUOTE>
      <p class="Style14"><STRONG class="Style14">Vous aurez besoin donc de :</STRONG></p>
      <p class="Style6">- Iphone, Ipad ou Ipod jailbreaké<BR>
        - Le logiciel iTools<BR>
        - Appsync à télécharger à partir de Cydia<BR>
        - l’Application   Appcake (l’alternative de Installous)<BR>
      - Un cable pour   lier votre appareil au port USB de votre PC ou MAC.</p>
      <p class="Style23"><STRONG>1- Installer AppSync :</STRONG></p>
      <p class="Style6">Quoique votre Appareil soit jailbreaké, vous ne pouvez pas installer des   applications qui n’existent pas sur Appstore et non signées par Apple. AppSync   sert donc à contourner ce blocage.</p>
      <p class="Style6">a- Lancez d’abord Cydia depuis votre téléphone, puis dans l’onglet <STRONG>Gérer, </STRONG>cliquez sur<STRONG> Sources, </STRONG>ensuite   sur<STRONG> Modifier </STRONG>juste en bas du niveau de votre batterie (97% pour   mon cas).</p>
      <p class="Style6"><img src="images/tuto-1.jpg" alt="installer des applications sans Itunes " width="579" height="390"><br>
        <br>
      </p>
    </td>
  </tr>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td><p class="Style6">b- Cette fois-ci, cliquez sur <STRONG>Ajouter</STRONG> juste en bas de votre   niveau Réseau (MOR IAM pour mon cas), ensuite tapez la source  et cliquez sur <strong>ajouter la source</strong>. Ignorez le message d’avertissement et cliquez sur <STRONG>Ajouter …and même .</STRONG></p>
    <p class="Style6"><img src="images/tuto-2.jpg" alt="installer des applications sans itunes" width="581" height="409"></p>
      <p class="Style6">c- Attendez que ça finisse puis cliquez sur <strong>Retour à Cydia</strong>, ensuite cliquez sur le nom du repo que vous venez d’ajouter.</p>
      <img src="images/tuto-3.jpg" alt="installer les applications sans itunes" width="579" height="406">
      </p>
      <p align="left" class="Style6">d- Recherchez AppSync correspondant à votre iOS (Pour connaitre la version votre iOS faites <strong>Réglages &gt; Général &gt; Information &gt; Version</strong>, pour mon cas c’est 5.1.1 [9B206]) et enfin cliquez sur Installer en haut.</p>
      <p align="left" class="Style6"><img src="images/tuto-4.jpg" alt="installer des apps sans itunes" width="581" height="426"></p>
      <p class="Style23">d- L’installation de AppCake :</p>      
      
      <p class="Style6">d- Recherchez l’application que vous souhaitez installer, sinon parcourez les applications disponibles puis procédez au téléchargement <strong>GRATUIT</strong> en sur Download puis à l’installation.</p>
      <p class="Style6"><img src="images/tuto-5.jpg" alt="installer des apps sans itunes" width="577" height="402"></p>
      <p class="Style6">Voilà c’est terminé !  Et à bientôt dans un autre tuto.</p>
      <p class="Style6">&nbsp;</p></td>
  </tr>
  <tr>
