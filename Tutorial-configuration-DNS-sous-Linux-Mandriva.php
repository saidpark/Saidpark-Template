...
<title>installation et configuration du serveur DNS sous Linux Mandriva</title>
<META name=title content="installation et configuration du serveur DNS sous Linux Mandriva">

<META lang=fr name=description content="Nous allons étudier la mise en oeuvre de trois services :Le serveur DNS Bind Sous Mandriva Linux (installation et configuration) en Darija, installer et configurer le serveur DHCP Sous Mandriva Linux en Darija, installer et configurer le FTP Sous Mandriva Linux en Darija Marocaine." />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Tutorial-configuration-DNS-sous-Linux-Mandriva.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Tutorial-configuration-DNS-sous-Linux-Mandriva.php">Administration des systèmes Linux en Darija Marocaine </a></p>
    <p align="center" class="Style12">installation et configuration du serveur DNS sous Linux Mandriva</p>
    <br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><strong>1. Introduction et pré-requis:</strong></p>
          <p class="Style6"> Nous allons étudier la mise en oeuvre de trois services :</p>
          <ul>
            <li class="Style6"><a href="./Tutorial-configuration-DNS-sous-Linux-Mandriva.php" target="_parent">Le serveur DNS Bind Sous Mandriva Linux (installation et configuration)</a></li>
            <li class="Style6"><a href="./Installer-et-configurer-le-serveur-DHCP-Sous-Mandriva-Linux.php" target="_blank">Installer et configurer le serveur DHCP Sous Mandriva Linux</a></li>
          ...
          <p class="Style6">Un serveur DNS est un serveur qui transforme une adresse du type http://example.fr en adresse IP 195.83.100.1. Le serveur DNS indique aussi le serveur SMTP (serveur de<br>
            messagerie) qui est autorisé à recevoir les messages pour votre domaine</p>
          <p class="Style6"><span class="Style6">La première raison d'avoir un serveur DNS dans un établissement est de disposer d'un serveur cache DNS afin d'accélérer les requêtes et de simplifier l'adressage des machines internes à l'établissement.afin d'accéder au serveur web de l'établissement,  serveur ftp, etc... plutôt que de retenir des adresses IP.</span></p>
          <p><strong>1.2 Installation du serveur DNS Bind  sous Mandriva</strong></p>
          <p class="Style6">Pour pouvoir configurer le DNS, il vous faut installer les logiciels &quot;bind&quot; et &quot;webmin&quot;. Commençons par l'installation du premier. Menu --&gt; Outil --&gt; Outil système --&gt; Installer et désinstaller des logiciels --&gt; Rechercher sur Tous : « bind » --&gt; Appliquer --&gt; OK.<br>
            Faire la même manipulation pour l’utilitaire &quot;webmin&quot;.</p>
          <p class="Style6">Je vous laisse suivre le Cours en video pour ne pas bruler les étapes :) </p></td>
        <td width="175"><p align="right"><img src="images/mandriva-linux.png" alt="switching ccna" width="183" height="185"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
      ...
      <p class="Style12">Partie 1: installation et configuration du serveur DNS sous Linux Mandriva</p>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td><p><span class="Style12">Partie 2 : installation et configuration du serveur DNS sous Linux Mandriva</span>
        <p align="center" class="Style6">
