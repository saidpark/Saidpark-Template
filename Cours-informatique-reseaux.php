...
<title>Maroc informatique formation en réseau | La théorie des réseaux</title>
<META name=title content="Maroc informatique formation en réseau | La théorie des réseaux">

<META lang=fr name=description content="Ce cours introduira tous les concepts en réseau : qu'est ce qu'un réseau ? Classification des réseaux, topologies des réseaux, réseaux client-serveur, modèle OSI, réseaux APPLETALK, ARPANET, couche ethernet, réseaux locaux et étendus, couche TCP/IP, messagerie, sécurité, système binaire..." />
<meta name="keywords" content="réseaux, réseau informatique, sécurité réseau, logiciel réseau, configuration réseau, réseau informatiques, administration réseau, architecture réseau, cours réseau, gestion réseau, entreprise réseau, réseau wifi, réseau internet, le réseau, installation réseau, partage réseau, connexion réseau, connection réseau, réseau local, réseau ethernet, serveur réseau, sous réseau, réseau sans fil, carte réseau, formation réseau, maintenance réseau, réseau ip, réseau adsl, réseau commercial, réseau haut débit, cablage réseaux, réseaux haut débit, sécurité réseau informatique, Cour vidéo, tutorial vidéo, formation vidéo, formation graphique, tutoriel vidéo, Maroc vidéo, vidéo Maroc, formation Maroc, cour logiciel, apprendre graphisme" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Cours-informatique-reseaux.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Cours-informatique-reseaux.php">Formation en réseau</a></p>
    <p align="center" class="Style12">La théorie des réseaux et le systéme binaire </p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Ce cours introduira tous les concepts en réseau : qu'est ce qu'un réseau ? Classification des réseaux, topologies des réseaux, réseaux client-serveur, modèle OSI, réseaux APPLETALK, ARPANET, couche ethernet, réseaux locaux et étendus, couche TCP/IP, messagerie, sécurité, système binaire...<br>
          Ce tutoriel a pour but de vous exposer les principes fondamentaux des réseaux.</p>
          <p class="Style6">Le cours est réalisé par le professeur wantknow</p></td>
        <td width="175"><div align="right"><img src="images/reseau.png" alt="cours reseau" width="235" height="151"></div></td>
      </tr>
    </table>    
    </td>
  </tr>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td><p class="Style23">Le système binaire
      <p class="Style6">Le système binaire est un système de numération utilisant la base 2. On nomme couramment bit (de l'anglais binary digit, soit « chiffre binaire ») les chiffres de la numération binaire positionnelle. Ceux-ci ne peuvent prendre que deux valeurs, notées par convention 0 et 1.<br>
        C'est un concept essentiel de l'informatique. En effet, les processeurs des ordinateurs sont composés de transistors ne gérant chacun que deux états.<br>
      Un calcul informatique n'est donc qu'une suite d'opérations sur des paquets de 0 et de 1, appelés octets lorsqu'ils sont regroupés par huit.</p>
