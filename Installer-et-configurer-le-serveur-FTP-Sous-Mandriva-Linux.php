...
<title>Installation et configuration du serveur FTP Sous Linux Mandriva</title>
<META name=title content="Installation et configuration du serveur FTP Sous Linux Mandriva">

<META lang=fr name=description content="Le service FTP est très souvent mis à la disposition des utilisateurs pour faire des téléchargements en « download » et moins souvent en « upload ». Cependant, il est plus facile de mettre en place un répertoire de téléchargement de manière sécurisé avec un serveur FTP qu'avec un serveur web et php. Il permet aussi de gérer plus finement l'occupation de la bande passante." />
<meta name="keywords" content="file transfert protocol, Installation et configuration, serveur SFTP,serveur FTP, MySecureShell, Console, Installer et supprimer des logiciels, Root, Ssh, Vi, fichiers de configuration, proftp, webmin, proftpd.conf, ProFTP server, passwd, etc/ftpusers, ftp, Port 21, daemon, userftp, serveur web, hebergé, heberger web, webmin, administrateur linux, cours darija maroc, tutorial darija, " />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Installer-et-configurer-le-serveur-FTP-Sous-Mandriva-Linux.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Installer-et-configurer-le-serveur-FTP-Sous-Mandriva-Linux.php">Administration des systèmes Linux en Darija Marocaine </a></p>
    <p align="center" class="Style12">installation et configuration du serveur FTP Sous Linux Mandriva</p>
    <br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><strong>1. Introduction et pré-requis:</strong></p>
          ...
          <ul>
            ...
            <li class="Style6"><a href="./Installer-et-configurer-le-serveur-DHCP-Sous-Mandriva-Linux.php" target="_blank">Installer et configurer le serveur DHCP Sous Mandriva</a></li>
            <li class="Style6"><a href="./Installer-et-configurer-le-serveur-FTP-Sous-Mandriva-Linux.php" target="_parent">Installer et configurer le FTP Sous Mandriva Linux</a></li>
          </ul>
          <p class="Style6"><strong>1.1 Présentation</strong></p>
          <p class="Style6">Le service FTP est très souvent mis à la disposition des utilisateurs pour faire des téléchargements en « download » et moins souvent en « upload ». Cependant, il est plus facile de mettre en place un répertoire de téléchargement de manière sécurisé avec un serveur FTP qu'avec un serveur web et php. Il permet aussi de gérer plus finement l'occupation de la bande passante.</p>
          <p><strong>1.2 Installation du Serveur FTP sous Mandrake </strong></p>
          <p class="Style6"> <span class="Style33">a) installation </span><br>
            L'Installer Proftp avec la commande :<br>
            # urpmi -a proftp</p>
          <p class="Style6"><span class="Style33">b) Configuration</span><br>
            Nous allons devoir certainement créer deux fichiers nécessaires à la configuration de proftp. Il s'agit de :<br>
            <strong>/etc/ftpusers</strong> et <strong>/etc/proftpd.conf</strong>.</p>
          <p class="Style6">Reste donc maintenant qu'à ouvrir le fichier <strong>ftpusers</strong> et enlever les lignes des utilisateurs auxquels on veut accorder l'accès au FTP, notamment <strong>adminftp</strong> et <strong>userftp</strong>.</p>
          <p class="Style6">Je vous laisse suivre le cours détaillé en Video </p></td>
        <td width="175"><p align="right"><img src="images/mandriva-Logo-ftp.png" alt="switching ccna" width="200" height="200"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
      ...
      <p class="Style12">Tutorial : Installation et configuration du serveur FTP Sous Linux Mandriva</p>
