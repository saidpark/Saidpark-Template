...
<title>Formation réseau à la marocaine La technologie VOIP et TOIP (Téléphonie sur IP)</title>
<META name=title content="Formation réseau à la marocaine La technologie VOIP et TOIP (Téléphonie sur IP)">

<META lang=fr name=description content="Voice Over IP : Ce terme représente une technologie utilisée pour transporter de la voix sur un réseau informatique de type IP (Réseau Internet et la plupart des réseaux locaux). " />
<meta name="keywords" content="voip,voice,over,Ip,voice over ip,voix,sur,ip, voix sur ip,toip,téléphonie,h323,h.323,h261,h.261,sip,rtp,rtcp,qos,cos,mgcp,ipbx,pabx,ipbx,gatekeeper,epbx,pabx ip,alcatel 4400,gateway,tcpip,voip,vpn,ip,ipv4,ipv6" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./la-technologie-voip-toip.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./la-technologie-voip-toip.php">Formation réseau </a></p>
    <p align="center" class="Style12">La technologie VOIP et TOIP (Téléphonie sur IP) </p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><span class="Style12">1. Présentation de la VOIP.</span></p>
          <p class="Style6">Voice Over IP : Ce terme représente une technologie utilisée pour transporter de la voix sur un réseau informatique de type IP (Réseau Internet et la plupart des réseaux locaux).<br>
            Le principe consiste à :</p>
          <ul>
            <li class="Style6">Convertir la voix (signal analogique) en un code numérique.</li>
            <li class="Style6">Compresser le code obtenu (pour diminuer la quantité de données à transmettre).</li>
            <li class="Style6">Supprimer les silences.</li>
            <li class="Style6">Expédier les données sur le réseau de la même manière qu’une page web ou un courrier par exemple :Identification (Port source, Port dest, @IP source, @IP dest, …)</li>
            </ul>
          <p class="Style12">2. La TOIP (Téléphonie sur IP) </p>
          <p class="Style6">La Telephony Over IP est un service de téléphonie qui utilise la technologie Voip. Ce service fonctionne sur les réseaux de type IP (Réseau Internet et la plupart des réseaux locaux).<br>
            Concrètement, au lieu d’utiliser deux réseaux distincts pour le téléphone est l’informatique, seul le réseau informatique est conservé. De la même manière, une partie des équipements seront communs (switchs).</p>
        ...
        <td width="175"><p align="right"><img src="images/hosted-voip.jpg" alt="voip" width="242" height="224"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
