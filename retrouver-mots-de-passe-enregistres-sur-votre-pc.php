...
<title>Retrouver tous les mots de passe enregistrés sur votre PC | Trucs et Astuces</title>
<META name=title content="Retrouver tous les mots de passe enregistrés sur votre PC | Trucs et Astuces">

<meta name="description" content="Cherchez-vous la méthode permettant de récupérer la totalité des mots de passe enregistrés sur votre ordinateur ? Voulez-vous les exporter." />
<meta name="keywords" content="mdp, mot de passe, recuperer, retrouver, dossier mot de pass, cacher dossier, sécuriser dossier, sécuriser pc, cacher donnes, Cour vidéo, tutorial vidéo, formation vidéo, formation graphique, tutoriel vidéo, Maroc vidéo, vidéo Maroc, formation Maroc, cour logiciel, apprendre graphisme" />
...
.Style20 {color: #006699; font-size: 15px;}
...
<table width="922" height="907" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
    <TBODY>
      ...
      <TR>
        <TD><span class="Style20">Pas encore de compte&nbsp;? </span><A 
...
<div align="right" bgcolor="#ffffff">
       <img src="images/bann.gif">
      </div>      <div align="right"><img src="images/presantation.gif" width="542" height="21"></div></th>
    <th width="160" rowspan="4" scope="col" bgcolor="#FFFFFF" bordercolor="#FFFFFF"><div id="pub">
  ...
  <tr>
    <td height="97"><p align="right" class="Style5">&nbsp;</p>
    <p align="center" class="Style14"><a href="./retrouver-mots-de-passe-enregistres-sur-votre-pc.php">Trucs et Astuces</a> </p>
    <p align="center" class="Style12">Comment retrouver tous les mots de passe enregistrés sur votre PC !</p><br></td>
  </tr>
  <tr>
    <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="587" height="164" border="0">
      <tr>
        <th scope="col"><div align="left" class="Style10">
       
          <div class="fb-like" data-href="./retrouver-mots-de-passe-enregistres-sur-votre-pc.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
          
          <p class="Style6">Cherchez-vous la méthode permettant de récupérer la totalité des mots   de passe enregistrés sur votre ordinateur ?</p>
          <p class="Style6">Dans le tutoriel d’aujourd’hui, vous allez découvrir plusieurs utilitaires,   développés par le géant <STRONG>Nirsoft</STRONG>, permettant de retrouver tous   types de mots de passes, y compris vos mots de passe enregistrés sur votre   navigateur, MSN ou sur n’importe quel logiciel…</p>
          <p class="Style6"><span class="Style12">Retrouver les mots de passe des navigateurs…</span></p>
          <strong class="Style5">Internet Explorer (IE Passview) :</strong></p>
          <p class="Style6">Si vous utilisez le navigateur <span class="Style5">Internet Explorer</span> (dernière version), l’utilitaire <span class="Style5">IE Passview</span> vous permettra de récupérer tous les mots de passe enregistrés sur votre navigateur en un temps record !</p>
          <p class="Style6">Vous pouvez télécharger <span class="Style5">IE Passview</span> en utilisant ce lien direct : </p>
          <p class="Style6">Décompressez le fichier avec <span class="Style5">Winrar</span> et ouvrez-le, l’utilitaire ne demande pas une installation…</p>
          <p class="Style6"><img src="images/1.bmp" alt="password recover" width="587" height="237"></p>
        </div></th>
        </tr>
      
      
    </table>    
      <p align="left" class="Style6">Vous pouvez exporter la liste entière en utilisant les touches “Ctrl+S” sous format text.</p>
      <p align="left" class="Style5">Google Chrome (ChromePass) :</p>
      <span class="Style6">Pour les utilisateurs du navigateur </span><span class="Style5">Google Chrome</span><span class="Style6">, je vous recommande d’utiliser cet utilitaire pour récupérer les mots de passes facilement et les exporter sous forme d’un fichier </span><span class="Style5">TXT</span><span class="Style6">, au lieu d’utiliser la méthode traditionnelle…</span>
      <p class="Style6">Vous pouvez utiliser ce lien pour télécharger la version portable de cet utilitaire : </p>
      <p class="Style6">Décompressez le fichier téléchargé en utilisant le Winrar, et lancez le programme…</p></td>
  </tr>
  <tr>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    <td height="21"  class="arrowlistmenu"><p><h3 class="headerbar">Visiteurs</h3></p>
    <p></p>
    <p></p></td>
    <td><p><div align="left">
</div></p>
  ...
  <tr>
    ...
    <td><p align="left" class="Style6">&nbsp;</p>
      <p class="Style6"><img src="images/2.bmp" alt="password recover" width="587" height="249"></p>
      <p align="left" class="Style6">Pour exporter la liste des mots de passes, sélectionnez premièrement les coordonnées que vous voulez exporter (pour tous sélectionner, tapez CTRL+A) puis cliquez sur “<strong>File</strong>” &gt; “<strong>Save Selected Items</strong>“… </p>
	<p align="left"><img src="images/31.bmp" alt="password recover" width="296" height="184"></p>
	<p align="left" class="Style6">Choisissez un emplacement et cliquez sur “<STRONG>Enregistrer</STRONG>“… Vous   pouvez même l’enregistrer sous format html </p>
	<p class="Style5">Mozilla Firefox (IE Passview) :</p>
	<span class="Style6">Même chose pour le </span><span class="Style5">Mozilla Firefox</span><span class="Style6">, vous pouvez utiliser l’utilitaire </span><span class="Style5">PasswordFox</span><span class="Style6"> pour récupérer vos mots de passe enregistrés…
    </p>
	</span>
	<p class="Style6">Voici le lien direct pour télécharger ce formidable utilitaire : </p>
	<p class="Style6"><img src="images/4.bmp" alt="password recover" width="587" height="254"></p>
	<p align="left" class="Style5">Opera (OperaPassView) :</p>
	<span class="Style6">Si vous utilisez </span><span class="Style5">Opera</span><span class="Style6"> comme navigateur, vous pouvez utiliser </span><span class="Style5">OperaPassView</span><span class="Style6"> pour restaurer vos mots de passes oubliés !
    </p>
	</span>
	<p class="Style6">Voici le lien de téléchargement :</p>
	<p class="Style6"><span class="Style5">Pour tous les navigateurs (WebBrowserPassView)</span></p>
	<p class="Style6">Vous pouvez, si vous utilisez plusieurs navigateurs télécharger l’utilitaire<span class="Style5"> WebBrowserPassView</span>, permettant de récupérer les mots de passes enregistrés sur les navigateurs suivants :<span class="Style5"> Internet Explorer, Mozilla Firefox, Google Chrome, Safari, </span>et <span class="Style5">Opera
	  </p>
	</p>
	  <p class="Style6">Vous pouvez télécharger l’utilitaire<span class="Style5"> WebBrowserPassView </span>en utilisant ce lien : </p>
	<p class="Style6">Décompressez l’archive téléchargé en utilisant Winrar, et ouvrez-le pour avoir directement vos mots de passes affichés !</p>
	<p align="left" class="Style6"><img src="images/6.bmp" alt="password recover" width="587" height="255"></p>
	<p class="Style6">Tapez simultanément “<STRONG>Ctrl+F</STRONG>” pour faire une recherche,   “<STRONG>Ctrl+A</STRONG>” pour tout sélectionner et “<STRONG>Ctrl+S</STRONG>”   pour exporter la liste des mots de passe !</p>	
	<p align="left" class="Style12">Comment récupérer les mots de passe des logiciels de chat (Messenger)</p>
	<p class="Style6">Voici un utilitaire qui est lui aussi créé par le géant <STRONG>Nirsoft</STRONG>, nommé<STRONG> MessenPass</STRONG>, cet utilitaire   permet de récupérer les mots de passe des logiciels suivants :</p>
	<UL>
      <LI class="Style6">MSN Messenger</LI>
	  <LI class="Style6">Windows Messenger (In Windows XP)</LI>
	  <LI class="Style6">Windows Live Messenger (In Windows XP/Vista/7)</LI>
	  <LI class="Style6">Yahoo Messenger (Versions 5.x and 6.x)</LI>
	  <LI class="Style6">Google Talk</LI>
	  <LI class="Style6">ICQ Lite 4.x/5.x/2003</LI>
	  <LI class="Style6">AOL Instant Messenger v4.6 or below, AIM 6.x, and AIM Pro.</LI>
	  <LI class="Style6">Trillian</LI>
	  <LI class="Style6">Trillian Astra</LI>
	  <LI class="Style6">Miranda</LI>
	  <LI class="Style6">GAIM/Pidgin</LI>
	  <LI class="Style6">MySpace IM</LI>
	  <LI class="Style6">PaltalkScene</LI>
	  <LI class="Style6">Digsby</LI>
    </UL>	
	<p class="Style6">Pous pouvez le télécharger en utilisant ce lien :</p>
	<p class="Style6">Décompressez-le avec  <STRONG>Winrar</STRONG> et ouvrez-le, les mots de   passes vont être affichés directement ! Voici l’interface de cet utilitaire   :</p>	<p align="left" class="Style12"><img src="images/9.bmp" alt="password recover" width="587" height="254"></p>
	<p align="left" class="Style6">Dans l’image ci-dessus, l’utilitaire a pu récupérer le mot de passe de   Google Talk, et Windows Live Messenger </p>
	<H2 class="Style12">Comment afficher les mots de passe cachés…</H2>	
	<p class="Style6">Si vous avez des mots de passe sous forme de balles noirs et que vous voulez   les récupérer en un temps record, je vous invite à utiliser   l’utilitaire BulletsPassView…</p>
	<p class="Style6">Vous pouvez télécharger l’utilitaire <STRONG>BulletsPassView</STRONG> via ce   lien direct :</p>
	<p class="Style6">Avant de lancer le programme, essayez d’ouvrir les logiciels ou il y a les   boîtes à textes des mots de passe… Vous pouvez utiliser le bouton  pour actualiser la liste, et refaire le scan des mots de passe   cachés sur votre écran…</p>	
	<p align="left" class="Style6"><img src="images/10.bmp" alt="password recover" width="536" height="255"></p>
	<p class="Style6">Pour <STRONG>FileZilla</STRONG>, il suffit d’ouvrir le gestionnaire des   sites, cliquer sur le site, puis taper<STRONG> F5</STRONG> dans le<STRONG> BulletsPassView</STRONG> pour afficher le <strong>mot de passe</strong> caché !<br><br></p>	
	</td>
  </tr>
  <tr>
