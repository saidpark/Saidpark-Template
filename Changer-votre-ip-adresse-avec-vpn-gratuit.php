...
<title>Changer votre adresse ip avec une connexion VPN gratuite! - Surf anonyme</title>
<META name=title content="Changer votre adresse ip avec une connexion VPN gratuite! - Surf anonyme">

<meta name="description" content="Un VPN (réseau privé virtuel) vous permet de vous connecter à un réseau distant de manière anonyme et sécurisée : Changer votre ip facilement avec un service vpn gratuit connectez vous avec 5 adresses ip (US – UK – DE – PL – FR)- surfer et télécharger en anonymat avec un VPN gratuit OpenVPN, PPTP, L2TP, SSTP." />
<meta name="keywords" content="vpn, free vpn, vpn gratuit, openvpn, enterprise vpn, open source vpn, vpn client, vpn server, virtual private network" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    ...
    <p align="center" class="Style14"><a href="./Changer-votre-ip-adresse-avec-vpn-gratuit.php">Changer votre adresse ip facilement</a> </p>
    <p align="center" class="Style12">Protéger l'accés à Internet avec une connexion VPN !!</p><br></td>
  </tr>
  <tr>
     <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="552" height="164" border="0">
      <tr>
        <th scope="col"><div align="left">
          <div class="fb-like" data-href="./Changer-votre-ip-adresse-avec-vpn-gratuit.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
          <span class="Style6">Nous savons tous que Maroc Telecom a bloqué le Skype ces mois derniérs ,on plus de ça j'ai remarqué pas mal de sites qui sont intérdits au maroc donc pour y accéder facilement il faut changer ip, on va suivre ensemble comment navigué avec une adresse ip ukraine,</span>
          <p class="Style14">Le téléchargement et l'installation de départ</p>
          <p class="Style6"><a href="http://swupdate.openvpn.org/community/releases/openvpn-2.2.2-install.exe" target="_blank" rel="nofollow">Télécharger ici:</a> la dernière version de l'OpenVPN  sur votre disque local.Double-clique sur le fichier téléchargé pour lancer l'installation.</p>
          <p align="center" ><img src="images/openvpn_step1_download.png" alt="vpn gratuit" width="395" height="198">
          <p align="center" ><img src="images/openvpn_step2_security_warning.png" alt="vpn gratuit" width="475" height="212">        </div></th>
        </tr>
      
      
    </table>    
      <div align="center"><img src="images/openvpn_step4_license_agreement.png" alt="vpn gratuit" width="513" height="399"></div></td>
  </tr>
  <tr>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td>
	<p align="center">&nbsp;</p>
	<p align="center"><img src="images/openvpn_step5_choose_components.png" alt="vpn gratuit" width="513" height="399"></p>
	<p align="center"><img src="images/openvpn_step6_install_location.png" alt="vpn gratuit" width="513" height="399"></p>
	<p align="center"><img src="images/openvpn_step7_installing.png" alt="vpn gratuit" width="503" height="386"></p>
	<p align="center"><span class="Style6">Cliquez sur &quot;Continuer&quot; pour poursuivre l'installation.</span></p>
	<p align="center"><img src="images/openvpn_step8_tap_installation.png" alt="vpn gratuit" width="396" height="308"></p>
	<p align="center"><img src="images/openvpn_step9_installation_complete.png" alt="vpn gratuit" width="513" height="399"></p>
	<p class="Style6">Vous avez réussi à installer le client Open VPN sur votre système Windows</p>
	<p class="Style6">Lorsque l'Assistant Installation est terminée, un dossier OpenVPN et raccourci de connexion apparaîtra dans votre menu Démarrer dossier Programmes.</p>
	<p class="Style6">Aucun compte n'est nécessaire pour accéder au serveur gratuit.</p>
	<p class="Style6"><A href="http://wired.s6n.com/vpn/arethusa-free.zip"></A> <A href="http://wired.s6n.com/vpn/arethusa-free.zip" target="_blank" rel="nofollow">Cliquez ici</A>: pour   récupérer les fichiers CA et Config pour le serveur gratuit et l'enregistrer sur votre bureau.<BR>
	  Maintenant, aprés avoir décompresser le fichier copiez le dans C:\Program Files\OpenVPN\config.</p>
	<p><img src="images/step.jpg" alt="démarrer open vpn" width="390" height="120">	  </p>
	<p><span class="Style6">Si vous exécutez Windows 7 ou Vista - un clic droit sur OpenVPN GUI application, sélectionnez l'onglet Propriétés &gt; Compatibilité, cochez sur Exécuter ce programme en tant qu'administrateur sous le niveau de privilège.</span></p>
	<p><img src="images/openvpn_step12_run_as_administrator.png" alt="démarrer open vpn" width="298" height="172"></p>
	<p class="Style6">Allez dans Démarrer &gt; Tous les programmes &gt; OpenVPN et cliquez sur OpenVPN GUI. <br>
	  Aller à la barre d'état système (en bas à droite où l'horloge est), faites un clic droit sur l'icône OpenVPN, et cliquez sur arethusa-free.vpn, Enter le nom d'utilisateur et le mot de passe ci-dessus, maintenant vous étes automatiquement connecté avec une adresse ip Ukraine,</p>
	<p class="Style6">Nom d'utilisateur : arethusa<br>
	  Mot de passe : tguaj88v7k<br>
	  Le mot de passe peut changer de temps en temps.</p>
	<p class="Style6">Aller à la page <A href="http://www.ip-adress.com" target="_blank" rel="nofollow">http://www.ip-adress.com </A>pour confirmer que vous avez la nouvelle adresse IP</p>
	<p class="Style6">Le serveur gratuit ne peut être utilisé que pour le surf web, tout le reste est bloqué.<br>
	  Méthode de connexion : OpenVPN TCP.<br>
	  Pas de limitation de vitesse mais le serveur peut être plein durant les heures de pointe.<br>
	  Limite de trafic : 1 Go / mois.<br>
	  Localisation du serveur : Ukraine.</p>
	<p>&nbsp;</p>
	</td>
  </tr>
  <tr>
