...
<title>Maintenance des ordinateurs - Connaitre les élements de votre PC</title>
<META name=title content="Maintenance des ordinateurs - Connaitre les élements de votre PC">

<meta name="description" content="Comme débutant, vous allez voir dans ce cours de quoi se compose un PC, ça veut dire du coté Hardware ou matériel, et comment ses composants sont montés sur le PC, très intéressant à savoir comme informations de base, pour vous aider a résoudre et comprendre le fonctionnement d´un ordinateur, c´est pas de la magie mais des termes qu´il faut connaître." />
<meta name="keywords" content="ordinateurs, ordinateur portable, achat ordinateur, vente ordinateur, pc ordinateur, ordinateur portables, comparatif ordinateur, informatique ordinateur, clavier ordinateur, composant ordinateur, cours ordinateur, reseau ordinateur, depannage ordinateur, unité centrale, matériel informatique, Cour vidéo, tutorial vidéo, formation vidéo, formation graphique, tutoriel vidéo, Maroc vidéo, vidéo Maroc, formation Maroc, cour logiciel, apprendre graphisme,"  />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97"><p align="right" class="Style5">&nbsp;</p>
      <blockquote>
        <p align="center" class="Style9">Formation en  Maintenance des ordinateurs </p>
      </blockquote>      
    <p align="center" class="Style5"><span class="Style10"><a href="./Maintenance.php">Connaitre les éléments de votre PC</a></span><a href="./Maintenance.php">.</a> </p><br></td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4"><table width="552" height="218" border="0" align="center">
      <tr>
        <th width="375" height="157" scope="col"><DIV align="justify" class="Style11">
            <p><div class="fb-like" data-href="./Maintenance.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div></p>
            <p>Comme débutant, vous allez voir dans ce cours de quoi se compose un PC, ça veut dire du coté Hardware ou matériel, et comment ses composants sont montés sur le PC, très intéressant à savoir comme informations de base, pour vous aider a résoudre et comprendre le fonctionnement d´un ordinateur, c´est pas de la magie mais des termes qu´il faut connaître, bon courage et bienvenue sur votre site  </p>
        </DIV></th>
        <th width="167" scope="col"><div align="right"><a href="./Maintenance.php"><img src="images/maintenance2.jpg" alt="maintenance des ordinateurs" width="148" height="135" border="0"></a></div></th>
      </tr>
      <tr>
