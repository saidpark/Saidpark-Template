...
<title>Formation réseaux à la marocaine Le protocole Frame Relay</title>

<META name=title content="Formation réseaux à la marocaine Le protocole Frame Relay">

<META lang=fr name=description content="Le protocole Frame Relay est un protocole à commutation de paquets situé au niveau de la couche 2 du modèle OSI, utilisé pour les échanges intersites (WAN) Standardisé en 1990, Frame Relay a remplacé le protocole X25 comme nouvelle technologie à base de commutation de paquets. " />
<meta name="keywords" content="frame relay, commutation, couche 2, X25, ATM, maroc telecom, RPV, RNIS, ANSI, couche réseau, modele OSI, protocole, topologie réseau, topologie, grands réseaux, Reseaux Etendus, Lan, Wan, Man" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./cours-reseau-Le-protocole-frame-relay.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./cours-reseau-Le-protocole-frame-relay.php">Formation réseau </a></p>
    <p align="center" class="Style12"> Le protocole Frame Relay </p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style12"><span class="Style6">Le protocole <strong>Frame Relay</strong> est un protocole à commutation de paquets situé au niveau de la couche 2 du modèle OSI, utilisé pour les échanges intersites (WAN)</span> <span class="Style6">Standardisé en 1990, Frame Relay a remplacé le protocole X25 comme nouvelle technologie à base de commutation de paquets</span></p>
          <p class="Style6">Les avantages de <strong>Frame Relay</strong></p>
          <ul>
            <li class="Style6">les réseaux à commutation de paquets fournissent un multiplexage de nombreuses données à travers un seul lien de communication</li>
            <li class="Style6">Une simple connexion à un fournisseur d'accès à un réseau à commutation de paquets est moins coûteux</li>
            <li class="Style6">Si 2 sites distants veulent communiquer via Frame Relay, ils ont donc juste à constituer un circuit entre ces sites, à travers le réseau Frame Relay</li>
          </ul></td>
        <td width="175"><p align="right"><img src="images/FrameRelay3.gif" alt="protocole frame relay" width="279" height="237"></p>
          </td>
      </tr>
    </table>    
      </td>
