...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Configuration-d-un-routage-statique-cisco-avec-packet-tracer.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Configuration-d-un-routage-statique-cisco-avec-packet-tracer.php">Formation en réseau</a></p>
    <p align="center" class="Style12">Configuration d'un routage statique cisco avec packet tracer</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Le but de ce cours c'est de rappeler les notions associées à l'adressage IP, à la réalisation de sous-réseaux et introduira aussi le routage statique.</p>
          <ul>
            <li class="Style6"><span class="Style12">
              Les matières présentées dans ce cours sont :</span><br>
              • Configuration générale d'un routeur Cisco<br>
              • Sauvegarde et restauration d'une configuration<br>
              • Établissement d'un plan d'adressage IP<br>
              • Configuration de routes statique            </li>
            <li><span class="Style12">Prérequis</span><br>
                <span class="Style6">Ce tutorial demande des connaissances théoriques sur l'adressage IP, présentées dans le chapitre <a href="./Cours-informatique-reseaux.php" target="_blank">« Couche Réseau ». </a>Une introduction à la configuration des routeurs Cisco est donnée dans le chapitre <a href="./configuration-des-routeurs-cisco.php" target="_blank">« Introductions routeurs Cisco »</a>. Il est recommandé d'en prendre connaissance avant de voir ce chapitre.</span></li>
            <li><span class="Style12"> Routage statique</span><br>
              <span class="Style6">La séparation d'un réseau informatique en plusieurs parties (sous-réseaux) permet de limiter<br>
              l'étendue d'un domaine de broadcast. L'utilisation d'un routeur est alors indispensable si l'on veut interconnecter ses sous-réseaux entre eux.<br>
              Le routeur aura pour fonction d'aiguiller les paquets en fonction de l'adresse IP destination<br>
              contenue dans le paquet et en fonction du contenu de la table de routage du routeur.<br>
              La table de routage du routeur contient des routes statiques  et des routes dynamiques, c'est à dire apprises grâce au dialogue entre les routeurs à l'aide d'un protocole de routage (RIP, OSPF etc.).</span></li>
          </ul>          </td>
        <td width="175"><p><img src="images/Network Connection Control Panel.png" alt="cours cisco " width="170" height="170"></p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
