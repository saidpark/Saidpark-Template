...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    ...
    <p align="center" class="Style12">Formation en bureautique : Microsoft Excel </p>
    <p align="center" class="Style9"><a href="./cours-formation-excel.php">Cours excel</a> </p><br></td>
  </tr>
  <tr>
    ...
    <td rowspan="4"><table width="566" height="191" border="0" align="center">
      <tr>
        <th width="391" height="141" scope="col"><div align="left">
          <p class="Style11"><div class="fb-like" data-href="./cours-formation-excel.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div></p>
          <p align="justify" class="Style11">Microsoft   Excel (officiellement Microsoft Office Excel) est un tableur composé de 65 536   lignes, 256 colonnes (jusqu'à la version 2007), dont le maximum de feuilles par   classeur est limité par la quantité de mémoire disponible, développé au départ   par Microsoft pour le Macintosh et porté ensuite sur Microsoft Windows. Il fait   partie de la suite Microsoft Office et est depuis sa version 5 (1993) le tableur   dominant sur ces plates-formes. Les fichiers produits à l'aide du logiciel   portent l'extension <EM>xls</EM> (<EM>xlsx</EM> à partir de la version   2007).</p>
          <p align="right"> <BR>
            </p>
        </div></th>
        <th width="165" scope="col"><div align="right"><a href="./Cours-programmation-avec-visual-basic.php"></a><a href="./cours-formation-excel.php"><img src="images/excel2.jpg" alt="cours excel" width="135" height="171" border="0"></a></div></th>
      </tr>
      <tr>
        <td height="21"><div align="center"><img src="images/tuto1[2].jpg" width="114" height="30" border="0"><img src="images/tuto2[2].jpg" width="114" height="30" border="0"><img src="images/tuto3.jpg" width="114" height="30" border="0"></div></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
