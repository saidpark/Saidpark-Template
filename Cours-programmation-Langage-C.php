...
<title>Programmation - Apprendre à programmer avec Langage C - Formation gratuite</title>
<META name=title content="Programmation - Apprendre à programmer avec Langage C - Formation gratuite">

<meta name="description" content="Le langage C  en informatique est un langage de programmation impératif conçu pour la programmation système. Inventé au début des années 1970 avec UNIX, C est devenu un des langages les plus utilisés. De nombreux langages plus modernes comme C++, PHP et Java reprennent des aspects de C. Dans ce Tutoriel on va parler des étapes suivantes:
 
   1. Introduction au langage de programmation C.
   2. Les composants d'un programme C: le code source et les données.
   3. Enregistrement de données: Variables et constantes.
   4. Des instructions, des expressions et des opérateurs.
   5. Bases de l'entrée(scanf) et de sortie(printf).
   6. Fonctions.
   7. Structures de contrôle." />
<meta name="keywords" content="programmation langage c, programme c, langage de programmation c, programmation c, cours programmation c, exercice programmation c, la programmation en c, programmation en langage c, programmer c, programmation pascal, programmation cours, programmation java, projet c, programmation informatique, tutoriel programmation, programmation debutant, formation algorithme, Cour vidéo, tutorial vidéo, formation vidéo, formation graphique, tutoriel vidéo, Maroc vidéo, vidéo Maroc, formation Maroc, cour logiciel, apprendre graphisme" />
...
.Style13 {color: #335566; font-weight: normal;}
...
.Style21 {font-size: 15px; color: #006699;}
...
<table width="919" height="822" align="center" bgcolor="#FFFFFF" bordercolor="#CCCCCC">
  ...
  <H3 align="center"><img src="images/images544.jpg" width="40" height="40"> <em>Identification</em></H3>
      ...
      href="sendpass.php"><em>Mot 
                      ...
                      <tr>
                        <td><span class="Style21">Pas encore de compte? </span><a 
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="93"><p align="center" class="Style13"><a href="./Cours-programmation-Langage-C.php"><strong>Cours Langage C</strong></a> </p>
      <p align="center" class="Style9">Introduction au langage de programmation C. </p> </td>
  </tr>
  <tr>
    <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4" class="Style12"><table width="571" height="194" border="0" align="center">
      <tr>
        <th width="372" class="Style13" scope="col"><p align="left"><div class="fb-like" data-href="./Cours-programmation-Langage-C.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div></p>
          <p align="left">Leçon n. 1:Introduction au langage de programmation C.</p>
          <p align="left">Leçon n. 2-1:Les composants d'un programme C: le code source et les données.</p>
          <p align="left">Leçon n. 2-2:Enregistrement de données: Variables et constantes.</p>
          <p align="left">Leçon n. 3:Des instructions, des expressions et des opérateurs.</p>
          <p align="left">Leçon n. 4:Bases de l'entrée(scanf) et de sortie(printf).</p>
          <p align="left">Leçon n. 5:Fonctions.</p>
          <p align="left">Leçon n. 6:Structures de contrôle.</p>
          <p align="left">Conclusion</p>          
          <p align="justify">&nbsp;</p>          </th>
        <th width="189" scope="col"><div align="right"><a href="./Cours-programmation-Langage-C.php"><img src="images/c.png" alt="programmation langage C" width="170" height="160" border="0"></a></div></th>
      </tr>
