...
<title>Comment créer un logo web avec illustrator | Web design</title>
<META name=title content="Comment créer un logo web avec illustrator | Web design">
<META lang=fr name=description content="Dans ce tutoriel video, on va créer ensemble un logo vectorisé en style web 2.0 avec Adobe Illustrator, nous utiliserons de nombreux effets comme des dégradés de couleurs, des jeux de lumières, des ombres et des reflets afin de donner une ambiance au logo vectorisé." />
<meta name="keywords" content="illustrator, adobe  illustrator, créer un logo, logo web, logo, web 2.0, web design, logo vectorisé,effet dégradé," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./creer-un-logo-web-avec-illustrator.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./creer-un-logo-web-avec-illustrator.php">Web design </a></p>
    <p align="center" class="Style12">Créer un logo web avec illustrator</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Dans ce tutoriel, nous réaliserons un logo vectorisé en style web 2.0 avec de nombreux effets comme des dégradés de couleurs, des jeux de lumières, des ombres et des reflets. Nous réaliserons ce logo sous Adobe Illustrator afin de donner une ambiance au logo vectorisé. Le logo sera ainsi redimensionnable dans toutes les tailles, à tous les formats sans perdre de résolution.<br>
          Adobe Illustrator est un des références majeures chez les professionnelles de la création graphique, en matière de dessin vectoriel et de mise en page. Son intégration avec le reste de la gamme Adobe permet par exemple de conserver les calques d'une image lorsqu'on la transfère par simple glisser-déposer d'un logiciel à un autre. La prise en main est relativement aisée depuis l'adoption d'une interface standardisée commune par exemple à Illustrator et Photoshop. Les principaux formats de fichiers vectoriels en vigueur sont supportés. Adapté aussi bien à la création de documents papier qu'à celle d'illustrations pour le web : logos, affiches...</p>
          </td>
        <td width="175"><div align="right">
          <p><img src="images/illustrator.png" alt="logo web illustrator" width="256" height="256"></p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
        </div></td>
