...
<title>La configuration de VLAN sur un switch Cisco avec packet tracer | Formation en réseau</title>
<META name=title content="La configuration de VLAN sur un switch Cisco avec packet tracer | Formation en réseau">
<META lang=fr name=description content="Dans ce tutorial, nous allons voir ce que c'est qu'un VLAN, comment il est possible de configurer un SWITCH pour qu'il gère plusieurs VLANS de façon statique et dynamique." />
<meta name="keywords" content="réseaux, réseau informatique, sécurité réseau, logiciel réseau, configuration réseau, réseau informatiques, administration réseau,vlan, vlan cisco, cisco, switch, vlan switch, switch cisco" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./La-configuration-de-VLAN-sur-un-switch-Cisco-avec-packet-tracer.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./La-configuration-de-VLAN-sur-un-switch-Cisco-avec-packet-tracer.php">Formation en réseau</a></p>
    <p align="center" class="Style12">La configuration de VLAN sur un switch Cisco avec packet tracer</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Dans ce tutorial, nous allons voir ce que c'est qu'un VLAN, comment il est possible de configurer un SWITCH pour qu'il gère plusieurs VLANS de façon statique et dynamique.<br>
            <span class="Style33">VLAN statique : </span> C'est la méthode la plus simple et aussi la moins souple, qui consiste à attribuer un port du SWITCH à un VLAN donné, en configurant statiquement le SWITCH. Nous n'avons besoin  que d'un SWITCH administrable.<br>
            <span class="Style23">VLAN dynamique : </span>Ici, nous ferons appel  à un procédé d'authentification, nous disposerons d'un SWITCH capable d'envoyer à un serveur d'authentification (RADIUS) l'adresse MAC de la station connectée à un port (login/password) Si l'adresse MAC est connue (authentification réussie), le serveur pourra envoyer au SWITCH le numéro de VLAN attaché à la station.Cette méthode est plus souple, puisqu'une station donnée pourra se connecter sur n'importe quel port.<br>
          Dans notre exemple, le SWITCH est configuré pour supporter deux VLANS, respectivement, nous devons configurer interface Ethernet physique de manière à ce qu'elle présente deux interfaces IP, chacune pour un VLAN. Il nous faut d'abord installer le paquetage &quot;vlan&quot; et les outils nécessaires à la gestion des VLANs.<br>
          La dernière étape consistera à :<br>
          <strong>• Créez et nommez deux VLAN</strong><br>
          <strong>• Vérifiez la connectivité</strong><br>
          <strong>• Affichez les informations d’interface VLAN.</strong></p>
          </td>
        <td width="175"><p align="right"><img src="images/lan-switch-cisco7.gif" alt="VLAN" width="243" height="201"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p></td>
