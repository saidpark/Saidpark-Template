...
<title>Le Protocole de routage OSPF en dialecte marocain | Formation Réseau</title>
<META name=title content="Le Protocole de routage OSPF en dialecte marocain | Formation Réseau">
<META lang=fr name=description content="Le protocole OSPF est un protocole de routage dynamique défini par l'IETF à la fin des années 80. Il a fait l'objet d'un historique relativement complexe de RFCs... " />
<meta name="keywords" content="le network, le dns,changer le dns,,Network, Informatique, Windows, Linux, Installation, Configuration, domain name, ldap, openldap, configuration ldap, serveur openldap, certification cisco, les certifications cisco, cours cisco, cisco systems, linux, ipv6, configuration ipv6, ipv6 routeur cisco, ccna1, ccna2, ccna3, ccna4, acl, ACL standard, ACL etendue, ACL nommer cisco vpn, ftp, server ftp, install ftp, ftp server, connexion ftp, linux, routeur cisco, exam ccna, voiip, Web Hosting, ISA server, la sécurité, information, info" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./le-protocole-de-routage-ospf.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./le-protocole-de-routage-ospf.php">Formation en réseau</a></p>
    <p align="center" class="Style12">Le Protocole de routage OSPF</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Le protocole OSPF est un protocole de routage dynamique défini par l'IETF à la fin des années 80.</p>
          <div class="Style23">Principales caractéristiques d’OSPF </div>
          <ul>
            <li class="Style6">Emission des mises à jour déclenchées par modification(s) topologique(s).</li>
            <li class="Style6">Connaissance exacte et complète de la topologie du réseau.</li>
            <li class="Style6">Chaque noeud connaît l’existence de ses voisins adjacents.</li>
          </ul>          </td>
        <td width="175"><div align="right"><img src="images/routage-ospf.png" alt="protocol OSPF" width="318" height="224"></div></td>
      </tr>
    </table>    
      <ul>
        <li class="Style6">Utilisation d’un arbre du plus court chemin d’abord (SPF Tree) et d’un algorithme du plus court chemin d’abord (Algorithme SPF appelé aussi l'algorithme de Dijkstra) pour générer la table de routage.</li>
        <li class="Style6">Envoi des mises à jour topologiques via une adresse multicast et non broadcast.</li>
        <li class="Style6">Utilisation moindre de la bande passante</li>
        <li class="Style6">Protocole de routage classless supportant le VLSM.</li>
        <li class="Style6">Requiert des routeurs plus puissants.</li>
        <li class="Style6">Domaines de routage exempts de boucles de routage</li>
        <li class="Style6">Métrique utilisée : le coût (chaque liaison a un coût).</li>
        <li class="Style6">Détermination et utilisation d’un ou plusieurs domaines de routage appelés Areas </li>
      </ul>
      
      <ul>
        <li class="Style6">Les réseaux multi-accès broadcast (BMA) comme Ethernet.</li>
        <li class="Style6">Les réseaux point-à-point.</li>
        <li class="Style6">Les réseaux multi-accès non broadcast ou encore Nonbroadcast multi-access (NBMA)</li>
        <li class="Style6">Les réseaux point-à-multipoint configuré manuellement par un administrateur</li>
    </ul>      
    </td>
  </tr>
  <tr>
