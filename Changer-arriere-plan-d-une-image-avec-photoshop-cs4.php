...
<title>Changer l'arrière plan d'une image avec photoshop cs4 | Photo design</title>
<META name=title content="Changer l'arrière plan d'une image avec photoshop cs4 | Photo design">
<META lang=fr name=description content="Parfois, on cherche à modifier l’arrière plan d’un portrait, de vos images de vacances ou d’une photo quelconque. Dans ce tutorial on va voir comment changer l'arrière plan derrière un personnage ou un objet sous photoshop CS4." />
<meta name="keywords" content="photoshop, photoshop tutorials, photoshop tutorial, photoshop cs, photoshop brushes, photoshop elements, photoshop download, photoshop plugins, photoshop CC, photoshop CS4, design," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Changer-arriere-plan-d-une-image-avec-photoshop-cs4.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Changer-arriere-plan-d-une-image-avec-photoshop-cs4.php">Photo design </a></p>
    <p align="center" class="Style12">Changer l'arri<span class="Style12">è</span>re plan d'une image avec photoshop cs4</p><br>    </td>
  </tr>
  <tr>
   <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="489" height="77" border="0">
      <tr>
        <td width="478"><p class="Style6">Parfois, on cherche à modifier l’arrière plan d’un portrait, de vos images de vacances ou d’une photo quelconque.<br>
          Dans ce tutorial on va voir comment changer l'arrière plan derrière un personnage ou un objet sous photoshop CS4.</p>
          <p align="center" class="Style6"><img src="images/photoshop.PNG" alt="photoshop" width="247" height="315"></p>
          <p class="Style6">
            Nous pourrions tout aussi bien utiliser un masque de fusion, la gomme ou d'autres outils mais voyons comment faire avec ce filtre fort intéressant.<br>
              <span class="Style32">Bref, je vous invite à suivre le cours en video : </span></p>
          <p align="center" class="Style6"><img src="images/tuto[1].jpg" alt="cours photoshop" width="130" height="30"></p></td>
        <td width="10">&nbsp;</td>
      </tr>
