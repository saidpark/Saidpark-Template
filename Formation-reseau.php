...
<title>Cours Réseau - configuration et topologie</title>
<META name=title content="Cours Réseau - configuration et topologie">

<meta name="description" content="Un réseau informatique est un ensemble d'ordinateurs reliés entre eux et échangeant des informations. Par analogie avec un filet nœud (node) l'extrémité d'une connexion, qui peut être une intersection de plusieurs connexions (un ordinateur, un routeur, un concentrateur, un commutateur)." />
...
<table width="923" height="150" border="0" align="center">
  <tr>
    <th width="782" scope="col"><div align="left"><img src="images/myfont.png" width="752" height="171" border="0">
...
<table width="921" height="892" border="0" align="center" bgcolor="#FFFFFF">
  <tr>
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    ...
    <p align="center" class="Style9"><a href="./Formation-reseau.php">Formation en réseau</a> </p>
    <p align="center" class="Style10">Configuration et topologie d'un réseau informatique</p><br></td>
  </tr>
  <tr>
   <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4"><table width="563" height="185" border="0" align="center">
      <tr>
        <th width="372" height="143" scope="col"><div align="left" class="Style11">
          <p><div class="fb-like" data-href="./Formation-reseau.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div></p>
          <p>Un réseau informatique est un ensemble d'ordinateurs reliés entre eux et échangeant des informations. Par analogie avec un filet nœud <EM>(node)</EM> l'extrémité d'une connexion, qui peut être une intersection de plusieurs   connexions (un ordinateur, un routeur, un concentrateur, un commutateur). </p>
          <p align="center"><img src="images/tuto[1].jpg" width="114" height="30" border="0"></p>
        </div></th>
        <th width="181" scope="col"><div align="right"><a href="./Formation-reseau.php"><img src="images/LAN.png" alt="informatique réseau" width="180" height="181" border="0"></a></div></th>
      </tr>
      <tr>
        <td height="26" colspan="2"><div align="left"></div></td>
        </tr>
