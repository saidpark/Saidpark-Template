...
<title>Configurer la connexion 3G Meditel sur Iphone | iPhone 5, iPhone 4S, iPhone 4, iPhone 3GS, iPhone 3G</title>
<META name=title content="Configurer la connexion 3G Meditel sur Iphone | iPhone 5, iPhone 4S, iPhone 4, iPhone 3GS, iPhone 3G">
<META lang=fr name=description content="L’opérateur marocain Meditel ne fournit malheureusement pas une configuration automatique de la connexion 3G pour l’iphone, et il faut donc le configurer manuellement. Suivez les images pour comprendre comment configurer la connexion 3G meditel sur l’Iphone." />
<meta name="keywords" content="iPhone 4S, iPhone 4, iPhone 3GS, iPhone 3G, connexion 3G pour l’iphone, iphone meditel, iphone 3g " />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./configurer-la-connexion-3g-meditel-sur-iphone.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./configurer-la-connexion-3g-meditel-sur-iphone.php">iPhone astuces</a> </p>
    <p align="center" class="Style12">Configurer la connexion 3G Meditel sur Iphone  </p><br>    </td>
  </tr>
  <tr>
   <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><p class="Style6">L’opérateur marocain Meditel ne fournit malheureusement pas une configuration automatique de la connexion 3G pour l’iphone, et il faut donc le configurer manuellement.</p>
      <p class="Style6">Suivez les images pour comprendre comment configurer la connexion 3G meditel sur l’Iphone</p>
      <p><STRONG>1- Allez dans réglages</STRONG> <strong>: </strong></p>
      <p class="Style23"><img src="images/IMG_0018.png" alt="iphone meditel" width="320" height="393"></p>
      <p><STRONG>2- Allez sur Réseau :</STRONG></p>
      <p><strong><img src="images/IMG_0019.png" alt="iphone meditel" width="320" height="368"></strong><br>
        <br>
      </p></td>
  </tr>
  <tr>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td><p><STRONG>3- <span class="Style23">Avant d’aller sur Réseau de données   cellulaires</span></STRONG>, <STRONG>activez d’abord la 3G et les données   cellulaires</STRONG>, <span class="Style6">puis allez sur</span> <STRONG>Réseau de données   cellulaire</STRONG></p>
    <p class="Style6"><span class="Style23"><img src="images/IMG_0020.png" alt="iphone meditel" width="320" height="421"></span></p>
      <p><STRONG>4- Faites rentrer les paramètres suivants :</STRONG></p>
      <PRE>a- Nom du point d'accés : internet1.meditel.ma (Sans Http://)</PRE>
      <PRE>b- Nom d'utilisateur : MEDINET (majuscule)</PRE>
      <PRE>c- Mot de passe : MEDINET (majuscule)</PRE>
      <p class="Style6">
      </p>
      <img src="images/IMG_0021.png" alt="iphone meditel" width="320" height="407">      </p>
      <p align="left" class="Style6">Cliquez sur le Home Button de votre Iphone et allez tester votre connexion, normalement ça doit marcher si vous avez déjà activé ce service. </p>
