...
<title>Cour PHP formulaire d'authentification avec PHP et Dreamweaver - Création de site web</title>
<META name=title content="Cour PHP formulaire d'authentification avec PHP et Dreamweaver - Création de site web">
<meta name="description" content="Dans le tuto d'aujourd'hui on va faire ensemble une page php pour s'identifier pour l'accès à une autre page, pour cela, il fallait créer une base de donnée Mysql dont on fait un tableau pour les infos d´utilisateur, la vérification sera relié avec cette base de donnée; donc cette fois il y´aura une connexion avec Mysql, cet exemple peut être appliqué pour restreindre l'accès á une zone avec identification." />
<meta name="keywords" content="créer un formulaire en php, formation php, zone authentification en php, php maroc, formation php, php maroc, arab php tutorial" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    ...
    <p align="center" class="Style11"><a href="./Cours-PHP-creer-un-formulaire-dauthentification-avec-php-et-dreamweaver.php">Cours php </a></p>
    <p align="center" class="Style9"><strong>Faire une page d'authentification en PHP avec Dreamweaver</strong> </p><br></td>
  </tr>
  <tr>
     <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4"><table width="552" height="164" border="0" align="center">
      <tr>
        <th width="377" height="137" scope="col"><div align="left" class="Style10">
          <p class="Style4"><div class="fb-like" data-href="./Cours-PHP-creer-un-formulaire-dauthentification-avec-php-et-dreamweaver.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div></p>
          <p class="Style4">Dans le tuto d'aujourd'hui on va faire ensemble une page php pour s'identifier pour l'accès à une autre page, pour cela, il fallait créer une base de donnée Mysql dont on fait un tableau pour les infos d´utilisateur, la vérification sera relié avec cette base de donnée; donc cette fois il y´aura une connexion avec Mysql, cet exemple peut être appliqué pour restreindre l'accès á une zone avec identification.</p>
          <p class="Style4">&nbsp;</p>
          <p align="center"><img src="images/tuto[1].jpg" width="114" height="30" border="0"></p>
        </div></th>
        <th width="165" scope="col"><div align="right"><img src="images/PHPFile[1].png" alt="cours php créer un formulaire" width="160" height="160" border="0"></a></div></th>
      </tr>
      <tr>
