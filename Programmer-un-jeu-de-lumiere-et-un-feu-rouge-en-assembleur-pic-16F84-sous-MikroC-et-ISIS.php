...
<title>Programmer un jeu de lumière et un feu rouge en pic 16F84 sous MikroC et ISIS | Maroc électronique robotique</title>

<META name=title content="Programmer un jeu de lumière et un feu rouge en pic 16F84 sous MikroC et ISIS | Maroc électronique robotique">

<META lang=fr name=description content="Le but de ce cours est de créer un jeu de lumiere pic 16F84 en assembleur sous MikroC ensuite nous devons réaliser un feu tricolore en ayant des temps d'allumage et d'extinction identiques pour chaque lampe, par exemple 3 secondes, la première façon de procéder est la suivante. " />
<meta name="keywords" content="Programmation, Mikroc, compiler, afficheur, LCD,Programmation sur Mikroc, afficheur LCD,chenillard, jeu de lumiére, feu rouge, isis, pic 16F84, electronique microcontroleur, microcontroleur video, microcontroleur programmation, microcontroleur programme, electronique microcontroleur,microcontroleur schema, microcontroleur 16f84, microcontroleur pic 16f84, allumer lumiere, allumer lumiere distance, detecteur allumer lumiere, allumer lumiere telecommande, allumer lumiere voix,electronique,robotique,PIC,robot,robots," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Programmer-un-jeu-de-lumiere-et-un-feu-rouge-en-assembleur-pic-16F84-sous-MikroC-et-ISIS.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Programmer-un-jeu-de-lumiere-et-un-feu-rouge-en-assembleur-pic-16F84-sous-MikroC-et-ISIS.php">Cours de programmation Microcontroleur PIC16F84</a></p>
    <p align="center" class="Style12"> Programmer un jeu de lumière et un feu rouge en pic 16F84  sous MikroC</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style12"><span class="Style6">Pour réaliser une application à base de PIC il va falloire écrire un programme en assembleur. nous pouvons utiliser l'editeur fourni dans l'outil de développement MiKroC disponible sur le site de <strong><em>microship</em></strong> une fois le programme en assembleur est réalisé vous pouvez avec <em><strong>ISIS PRO </strong></em> réaliser une simulation.</span></p>
          <p class="Style6">Le but de ce cours est de créer un jeu de lumière<em><strong> </strong></em>en assembleur sous <em><strong>MikroC.</strong></em> L'élément principal est un <em><strong>microcontroleur PIC16F84</strong></em>. Programmé à partir d'un code source assembleur, le PIC va allumer les une à la suite des autres chacune des différentes LEDS. Ensuite nous devons réaliser un feu rouge tricolore en ayant des temps d'allumage et d'extinction identiques pour chaque lampe.</p>
          </td>
        <td width="175"><p align="right"><img src="images/3497672762454_l_f_l_0.jpg" alt="jeu de lumiere pic 16f84" width="267" height="188"></p>
          </td>
      </tr>
    </table>    
      <p><span class="Style12">Cours n°1: Programmer un jeu de lumiere pic 16F84 en assembleur sous MikroC</span></p>
      <p align="center" class="Style6">
     
      <p align="left" class="Style12">Cours n°2: Programmer un feu rouge avec le Microcontrôleur pic16F84 sous MikroC</p>
      </td>
  </tr>
  <tr>
