...
<h3 align="left" class="headerbar">Annonces</h3></td>
  ...
  <div class="roknewspager-wrapper">
    <a href="./Formation-reseau-ccna-switching-commutation-LAN.php"><img src="images/1013073_209069952577720_1593983979_n.jpg" width="120" height="90" border="0" style="float: left; margin: 0 10px 5px; margin-top:26px; border: 1px solid gray" /></a>
		<ul class="roknewspager">
		 <li>
           <div class="roknewspager-div">
	            	            <a href="./Formation-reseau-ccna-switching-commutation-LAN.php" class="roknewspager-title">Formation réseau à la marocaine CCNA : Switching</a>				
	            	            <div class="introtext Style25"><span class="Style33">Switching ou bien Commutation LAN est une forme de commutation de paquets utilisé dans les réseaux locaux . Les technologies de commutation sont cruciales...</span></div>												
	     ...
	     <div class="roknewspager-wrapper"> 
		 <a href="./cours-reseau-Le-protocole-frame-relay.php"><img src="images/FrameRelay3.gif" width="120" height="90" border="0" style="float: left; margin: 0 10px 5px; margin-top:23px; margin-left:0; border: 1px solid gray" /></a>
		<li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="introtext Style25">Le protocole Frame Relay est un protocole à commutation de paquets situé au niveau de la couche 2 du modèle OSI, utilisé pour les échanges intersites (WAN).</div>												
                                <div class="published-date">25 juillet   2013</div>	            	            
                                <a href="./cours-reseau-Le-protocole-frame-relay.php" class="readon"><span>Lire plus...</span></a>	        </div>
	      </li>
		  
		  <div class="roknewspager-wrapper"> 
		  <a href="./Formation-reseau-a-la-marocaine-Le-Protocole-EIGRP.php"><img src="images/eigrp.PNG" width="120" height="90" border="0" style="float: left; margin: 0 10px 5px; margin-top:23px; margin-left:0; border: 1px solid gray" /></a> 
		   <li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="introtext Style25"><span class="Style33">EIGRP Enhanced Interior Gateway Routing Protocol est un protocole de routage développé par Cisco dans le but d’améliorer le protocole IGRP et  le rendre plus stable.</span></div>												
		...
		<div class="roknewspager-wrapper">
		 <a href="./la-technologie-voip-toip.php"><img src="images/hosted-voip.jpg" width="120" height="90" border="0" style="float: left; margin: 0 10px 5px; margin-top:23px; margin-left:0; border: 1px solid gray" /></a>
		   <li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="introtext Style25">La VOIP est une technologie utilisée pour transporter de la voix sur un réseau informatique de type IP (Réseau Internet et la plupart des réseaux locaux).</div>												
                                <div class="published-date">24 juillet 2013</div>	            	            
                                <a href="./la-technologie-voip-toip.php" class="readon"><span>Lire plus...</span></a>	        </div>
	      </li>
		  <div class="roknewspager-wrapper">
		  <a href="./Programmer-un-jeu-de-lumiere-et-un-feu-rouge-en-assembleur-pic-16F84-sous-MikroC-et-ISIS.php"><img src="images/3497672762454_l_f_l_0.jpg" width="120" height="90" border="0" style="float: left; margin: 0 10px 5px; margin-top:23px; margin-left:0; border: 1px solid gray" /></a>
		   <li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="introtext Style25">Le but de ce cours est de créer un jeu de lumiere pic 16F84 en assembleur sous MikroC et ISIS ensuite nous devons réaliser un feu tricolore.</div>												
		  ...
		  <div class="roknewspager-wrapper">
		  <a href="./programmer-un-afficheur-7-segments-avec-microcontroleur-pic-16f84-en-MiKroC-et-ISIS.php"><img src="images/minuteur.JPG" width="120" height="90" border="0" style="float: left; margin: 0 10px 5px; margin-top:23px; margin-left:0; border: 1px solid gray" /></a>
		  <li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="introtext Style25">Le but de ce cours est de programmer une cible (un affichage 7 segments) mais surtout de comprendre comment convertir une donnée binaire en donnée décimale.</div>												
                                <div class="published-date">23 juillet     2013</div>	            	            
		   ...
		   <div class="roknewspager-wrapper">
		   <a href="./Programmer-un-microcontroleur-pic-16f84-en-Entree-avec-MiKroC-et-ISIS.php"><img src="images/electronic-repair1.jpg" width="120" height="90" border="0" style="float: left; margin: 0 10px 5px; margin-top:23px; margin-left:0; border: 1px solid gray" /></a>  
		   <li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="introtext Style25">Nous allons revenir aujourd'hui plus en détail sur les ports d'Entrées-sorties ainsi que leur mode de configuration.</div>												
		  ...
		  <div class="roknewspager-wrapper">
		  <a href="./afficheur-LCD-avec-microcontroleur-PIC-16F84.php"><img src="images/lcd_avant.jpg" width="120" height="90" border="0" style="float: left; margin: 0 10px 5px; margin-top:23px; margin-left:0; border: 1px solid gray" /></a>
		<li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="introtext Style25">Le but principal de ce projet est d’afficher sur l’écran LCD des valeurs données par différents capteurs.</div>												
                                <div class="published-date">22 juillet   2013</div>	            	            
                                <a href="./afficheur-LCD-avec-microcontroleur-PIC-16F84.php" class="readon"><span>Lire plus...</span></a>	        </div>
	      </li>
		  <div class="roknewspager-wrapper">
		  <a href="./la-virtualisation-et-le-cloud-computing-formation-gratuite.php"><img src="images/virtualisation.jpg" width="120" height="90" border="0" style="float: left; margin: 0 10px 5px; margin-top:23px; margin-left:0; border: 1px solid gray" /></a>
								<li>
	        <div class="roknewspager-div">
	            	            ...
	            	            <div class="introtext Style25">Voici la premiére formation gratuite au Maroc en virtualisation de serveurs basée sur vSphere de VMware. Cette formation vous permettra d’acquérir des compétences</div>												
	                            ...
	                            <div align="right"><a href="./articles-suivants-page-2.php"><img src="images/suivant.bmp" alt="suivant" width="33" height="35" border="0"></a></div>
      </ul></div>
	</td>
  </tr>
  <tr>
