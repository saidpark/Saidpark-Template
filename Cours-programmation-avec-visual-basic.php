...
<title>Programmation - Apprendre la programmation avec Visual Basic - Formation gratuite</title>

<META name=title content="Programmation - Apprendre la programmation avec Visual Basic - Formation gratuite">

<meta name="description" content="Que vous soyez un débutant en programmation ou un programmeur qui a de l'expérience avec les langages procéduraux, vous allez trouver Visual Basic intéressant ...
L'interface de Visual Basic est visuel. C'est à dire que vous travaillez avec des objets que vous pouvez manipuler à l'écran : vous dessinez un objet Form et vous pouvez le traîner, le réduire, l'agrandir avec quelques cliques de la souris. Le langage utilise tous les outils de Windows pour simplifier votre tâche.
C'est le début d'une série complète de ce magnifique logiciel où on vas voir une introduction, plus la manipulation de form." />
<meta name="keywords" content="code visual basic, msgbox visual basic, visual basic source, application visual basic, listbox visual basic, textbox visual basic, microsoft visual basic, visual basic access, visual basic 6, msdn visual basic, visual basic excel, visual basic vba, visual basic runtime, visual basic, visual basic 6.0, visual basic 2005, download visual basic, visual basic edition, visual basic free, book visual basic, ms visual basic, form visual basic, visual basic pdf, using visual basic, with visual basic, tutorial visual basic 6, programming with visual basic, download microsoft visual basic, microsoft visual basic 6, visual basic professional, learn visual basic 6, visual basic 6 full, visual basic pro, ocx visual basic, visual basic editor, visual basic 2003, visual basic for application, visual basic for applications, livre visual basic, visual basic.net, vb database, microsoft visual basic .net, download vb, tutoriel visual basic, tutorial visual basic, formation visual basic, Cour vidéo, tutorial vidéo, formation vidéo, formation graphique, tutoriel vidéo, Maroc vidéo, vidéo Maroc, formation Maroc, cour logiciel, apprendre graphisme" />
...
.Style12 {font-size: 18px; color: #666666; font-weight: bold; }
...
.Style13 {color: #006699; font-size: 15px;}
...
<table width="923" height="150" border="0" align="center">
  <tr>
    <th width="783" scope="col"><div align="left"><img src="images/myfont.png" width="752" height="171" border="0">
...
<table width="920" height="892" border="0" align="center" bgcolor="#FFFFFF">
  <tr>
  ...
  <TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
    ...
    <th width="586" scope="col"><div align="right"><img src="images/maroc informatique.gif" width="542" height="21"></div>      
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    ...
    <p align="center" class="Style12"><a href="./Cours-programmation-avec-visual-basic.php">Cours Visual Basic</a> </p>
    <p align="center" class="Style9">Apprendre à programmer avec visual basic</p><br></td>
  </tr>
  <tr>
     <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4"><table width="552" height="191" border="0" align="center">
      <tr>
        <th width="371" height="141" scope="col"><div align="left">
          <p class="Style11"><div class="fb-like" data-href="./Cours-programmation-avec-visual-basic.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div></p>
          <p class="Style11">Que vous soyez un débutant en programmation ou un programmeur qui a de l'expérience avec les langages procéduraux, vous allez trouver Visual Basic intéressant ...L'interface de Visual Basic est visuel. C'est à dire que vous travaillez avec des objets que vous pouvez manipuler à l'écran : vous dessinez un objet Form et vous pouvez le traîner, le réduire, l'agrandir avec quelques cliques de la souris. Le langage utilise tous les outils de Windows pour simplifier votre tâche.</p>
          <p class="Style11">&nbsp;</p>
           <BR>
            </p>
        </div></th>
        <th width="171" scope="col"><div align="right"><a href="./Cours-programmation-avec-visual-basic.php"><img src="images/vb visual studio.bmp" alt="cours visual basic" width="148" height="135" border="0"></a></div></th>
      </tr>
      <tr>
        <td height="21"><div align="center"><img src="images/tuto[1].jpg" width="114" height="30" border="0"></div></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
...
<h3 class="headerbar">Visiteurs</h3></td>
  ...
  <tr>
    <td height="211"><p align="center" class="Style5">Qui est en ligne ?</p>
    <p align="center"> 
