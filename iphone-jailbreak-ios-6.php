...
<title>[Tuto] Jailbreak iOS 6 pour votre iPhone | iPhone 5, iPhone 4S, iPhone 4, iPhone 3GS</title>
<META name=title content="[Tuto] Jailbreak iOS 6 pour votre iPhone | iPhone 5, iPhone 4S, iPhone 4, iPhone 3GS">
<META lang=fr name=description content="Voilà enfin après de longues heures d’attente, le jailbreak Evasi0n ios 6 pour votre iphone est finalement disponible! Cette fois l’opération a été largement simplifiée, rien que quelques cliques et le tour est joué." />
<meta name="keywords" content="iPhone 5, iPhone 4S, iPhone 4, iPhone 3GS, jailbreak Evasi0n, ios 6 jailbreak" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./iphone-jailbreak-ios-6.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./iphone-jailbreak-ios-6.php">iPhone astuces </a> </p>
    <p align="center" class="Style12">[Tuto] Jailbreak iOS 6 pour votre iPhone</p><br>   </td>
  </tr>
  <tr>
   <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><p class="Style6">Voilà enfin après de longues heures d’attente, le jailbreak Evasi0n est   finalement disponible! Cette fois l’opération a été largement simplifiée, rien   que quelques cliques et le tour est joué. Vous aurez besoin de :</p>
      <UL><LI class="Style6">Jailbreak Evasi0n : Cliquez pour télécharger (Windows)</LI>
      </UL>
      <p class="Style6"><STRONG>Première étape :</STRONG> Connectez votre appareil via le câble USB à votre ordinateur. Attendez qu’Evasi0n reconnaisse votre iPhone, iPad ou iPod touch puis cliquez sur <strong>Jailbreak</strong>.</p>
      <p class="Style6"><img src="images/Sans-tsssitre.png" alt="iphone jailbreak ios 6" width="579" height="275"></p>
      <p class="Style6"><STRONG>Deuxième étape :</STRONG>La procédure va se lancer progressivement, comptez moins de 5 minutes pour que le tout se termine. <strong>Ne touchez pas votre appareil !</strong></p>
      <p class="Style6"><STRONG>Troisième étape :</STRONG>A partir d’un moment, un message va apparaitre. Il vous est demandé de déverrouiller votre appareil puis de chercher l’icône <strong>« Jailbreak »</strong> qui s’est créée. Cliquez sur cette dernière. Un écran noir apparait, c’est normal.</p>
      <p align="center" class="Style6"><img src="images/Application-iOS-Jailbreak-Evasi0n.jpg" alt="ios jailbreak evasion" width="112" height="117"></p>
...
<li><a href="./Programmer-en-assembleur-un-PIC16F84A.php">Electronique numérique </a></li>
  ...
  <tr>
    ...
    <td><p><span class="Style6"><STRONG>Dernière étape :</STRONG> Au milieu du processus du Jailbreak, si   votre appareil se verrouille automatiquement, un message clignotant   va apparaître sur votre écran vous demandant ainsi de déverrouiller votre   iDevice, ainsi que vous devez à cette occasion cliquer sur une icone intitulée   Jailbreak sur votre iDevice pour qu’il puisse continuer.
    </span>
    
      <p class="Style6">Voilà c’est tout! C’est très simple, maintenant vous devez laisser votre   ordinateur faire son travail, votre iDevice va devoir redémarrer plusieurs fois.   Quand il aura terminé, vous remarquerez certainement l’icone Cydia sur votre   Springboard.</p>
      <p class="Style6">Votre iDevice est maintenant jailbreaké, profitez en et n’oubliez de partager   avec vos amis!      </p>
