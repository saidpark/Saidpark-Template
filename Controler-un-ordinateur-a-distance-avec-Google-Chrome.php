...
<title>Contrôler un ordinateur à distance avec Google Chrome | Bureau à distance</title>
<META name=title content="Contrôler un ordinateur à distance avec Google Chrome | Bureau à distance">

<META lang=fr name=description content="L'application Bureau à distance Google Chrome développée par Google est une extension Chrome intégré dans votre navigateur qui vous permet en effet de contrôler votre bureau à distance de partager votre machine et vos fichiers ,et de configurer votre ordinateur pour que vous puissiez y accéder à distance de façon sécurisée, depuis un autre PC. Vous pouvez également accorder l'accès à distance à un ami pour qu'il vous dépanne." />
<meta name="keywords" content="Distance, distance, Remote, ordinateur, Tutoriel,Chrome, Bureau, Desktop, Contrôler, bureau,chrome,chromebook,contrôle,extension,google,pc,navigateurs" />
...
.Style37 {font-size: 13px; font-weight: bold; color: #006699; }
-->
</style>
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Controler-un-ordinateur-a-distance-avec-Google-Chrome.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Controler-un-ordinateur-a-distance-avec-Google-Chrome.php">Bureau à distance</a></p>
    <p align="center" class="Style12">Contrôler un ordinateur à distance avec Google Chrome</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">L'application <strong>Bureau à distance Google Chrome </strong> développée par Google est une extension Chrome intégré dans votre navigateur qui vous permet en effet de contrôler votre bureau à distance  de partager votre machine et vos fichiers ,et de configurer votre ordinateur pour que vous puissiez y accéder à distance de façon sécurisée, depuis un autre PC. Vous pouvez également accorder l'accès à distance à un ami pour qu'il vous dépanne.</p>
          <p class="Style6">Une fois l’extension installée, il vous faut lancer l’application. Cela peut se faire depuis le Chrome Web Store en cliquant sur le bouton “Lancer l’application”, ou directement depuis votre menu d’applications accessible depuis Chrome.</p>
          <p class="Style6">l’application génère un code d’authentification unique de 12 chiffres, qu’il vous faut communiquer à la personne à laquelle vous allez donner accès à votre machine, Une fois le code saisi, la session de partage (sécurisée) est lancée La personne aux commandes peut contrôler à distance immédiatement votre PC</p>
          <p class="Style32">Je vous invite à suivre le cours en video : </p></td>
        <td width="175"><div align="right">
          <p><img src="images/chrome-remote-desktop.png" alt="chrome remote desktop" width="233" height="196"></p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
