...
<title>Cours Java (J2EE) - Apprendre la programmation - Formation gratuite</title>
<META name=title content="Cours Java (J2EE) - Apprendre la programmation - Formation gratuite">
...
<meta name="keywords" content="programmation java, formation java, tutorial java, java maroc, J2EE, java maroc, java pour les nuls vidéo, java pour les débutants, java maroc, formation java maroc" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="93"><p align="center" class="Style13"><a href="./cours-java-j2ee-programmation.php"><strong>Cours Java :(J2EE)</strong></a> </p>
      <p align="center" class="Style9"> Apprendre à programmer avec Java : (J2EE)</p></td>
  </tr>
  <tr>
     <td height="21" class="arrowlistmenu">

<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4" class="Style12"><table width="563" height="194" border="0" align="center">
      <tr>
        <th width="392" height="137" class="Style13" scope="col"><p><div class="fb-like" data-href="./cours-java-j2ee-programmation.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div></p>
          <p align="left">Java Enterprise Edition, ou Java EE (anciennement J2EE), est une spécification pour la technique Java de Sun plus particulièrement destinée aux applications d’entreprise. Ces applications sont considérées dans une approche multi-niveaux[1]. Dans ce but, toute implémentation de cette spécification contient un ensemble d’extensions au framework Java standard (JSE, Java Standard Edition) afin de faciliter la création d’applications réparties.<br>
            Avec le langage Java, vous pouvez développer, des applications Desktop, développer des applets pour vos sites web, développer des sites en JSP, des applications pour téléphone mobile. La première chose à faire est bien évidemment d'apprendre à faire des applications standalones simples.</p>
          </th>
        <th width="161" scope="col"><div align="right"><a href="./cours-java-j2ee-programmation.php"><img src="images/java.png" alt="cours java (j2ee)" width="128" height="128" border="0"></a></div></th>
      </tr>
      <tr>
