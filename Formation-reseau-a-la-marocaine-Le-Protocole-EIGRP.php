...
<title>Formation réseau à la marocaine : Le Protocole EIGRP</title>
<META name=title content="Formation réseau à la marocaine : Le Protocole EIGRP">

<META lang=fr name=description content="EIGRP signifie Enhanced Interior Gateway Routing Protocol c’est un protocole de routage développé par Cisco dans le but d’améliorer le protocole IGRP et notamment le rendre plus stable. Ce protocole est donc uniquement compatible avec les produits Cisco. EIGRP utilise l’algorithme DUAL (Diffusing Update Algorithme) qui a été développé à SRI International. " />
<meta name="keywords" content="Protocole EIGRP, routage, OSPF, RIP, EGP, BGP, réseaux, réseau informatique, sécurité réseau, logiciel réseau, configuration réseau, réseau informatiques, administration réseau, architecture réseau, cours réseau, subnetting, static route, routage statique" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Formation-reseau-a-la-marocaine-Le-Protocole-EIGRP.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Formation-reseau-a-la-marocaine-Le-Protocole-EIGRP.php">Formation réseau </a></p>
    <p align="center" class="Style12">Formation  réseau à la marocaine :  Le Protocole EIGRP</p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><span class="Style12">1 - Présentation du protocole EIGRP</span></p>
          <p class="Style6"><em>EIGRP</em> signifie Enhanced Interior Gateway Routing Protocol c’est un protocole de routage développé par Cisco dans le but d’améliorer le protocole IGRP et notamment le rendre plus stable. Ce protocole est donc uniquement compatible avec les produits Cisco. EIGRP utilise l’algorithme DUAL (Diffusing Update Algorithme) qui a été développé à SRI International.</p>
          <p class="Style12">2 - Caractéristiques et fonctionnement du protocole EIGRP</p>
          <p class="Style6"><em>EIGRP</em> utilise un routage hybride qui s’appuie sur des vecteurs de distance et d’état de liens. Les métriques utilisées par EIGRP sont donc principalement la bande passante, la mémoire ainsi que la surcharge des processeurs.<br>
            Le routeur qui est configuré pour utiliser le protocole <em>EIGRP</em> va garder en mémoire toutes les tables de routage de ces voisins ce qui permet en cas de défaillance du réseau de trouver très rapidement un chemin alternatif.</p>
        ...
        <td width="175"><p align="right"><img src="images/eigrp.PNG" alt="protocole eigrp" width="228" height="129"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
