...
<title>Configuration d'un routeur cisco en dialecte marocain | Formation Réseau</title>
<META name=title content="Configuration d'un routeur cisco en dialecte marocain | Formation Réseau">

<META lang=fr name=description content="Ce cours a pour but de vous expliquer plus ou moins en détail comment configurer un routeur Cisco pour des réseaux locaux et des petits réseaux d'entreprise. Vous trouverez quelques exemples afin de mieux comprendre comment fonctionnent les protocoles de communications TCP/IP, IPX et NETBEUI" />
<meta name="keywords" content="commandes windows, commandes réseaux,commandes linux, commandes de programmation, commandes Dos, l'invite de commandes , shell, la console de récupération, cmd, commandes internes, commandes externes, tutorial commandes, installation de linux, linux, packet tracer, GNS3," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./configuration-des-routeurs-cisco.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./configuration-des-routeurs-cisco.php">Formation en réseau</a></p>
    <p align="center" class="Style12">La configuration d'un routeur cisco </p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Ce cours a pour but de vous expliquer plus ou moins en détail comment configurer un routeur Cisco pour des réseaux locaux et des petits réseaux d'entreprise. Vous trouverez quelques exemples afin de mieux comprendre comment fonctionnent les protocoles de communications TCP/IP, IPX et NETBEUI..<br>
          GNS3 est un simulateur d'équipements Cisco. Cet outil permet donc de charger de véritable IOS Cisco et de les utiliser en simulation complète sur un simple ordinateur.<br>
          Voir aussi :<a href="./Cours-informatique-reseaux.php" target="_blank">La théorie des réseaux et le systéme binaire<br>
          </a>Le cours est réalisé par le professeur wantknow</p>
          </td>
        <td width="175"><div align="right"><img src="images/logo_gns3_small.png" alt="cisco routeur emulation" width="250" height="177"></div></td>
      </tr>
    </table>    
    <p align="left" class="Style6"><span class="Style12">Partie 1 : Les composants d'un Routeur Cisco</span></p>
    <p align="center" class="Style6">
     
    <p align="left" class="Style12">Partie 2 : Installation d'un emulateur gns3</p>
