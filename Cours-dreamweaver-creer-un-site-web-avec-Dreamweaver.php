...
<title>Cours dreamweaver - création de site web |Formation et Logiciel</title>
<META name=title content="Cours dreamweaver - création de site web |Formation et Logiciel">
<meta name="description" content="Apprendre à créer facilement un site avec Dreamweaver! Un site web est composé de plusieurs pages web liées entre elles, gagné du temps avec Dreamweaver il est aussi considéré comme le meilleur logiciel de création de site web. lors de la création de vos pages web avec Dreamweaver vous aurez la possibilité de basculer entre les modes « Code » (partie contenant le code source) et « Création » (partie visuelle)" />
<meta name="keywords" content="créer, page, web, dreamweaver, formation dreamweaver, Cours Dreamweaver, tutorial dreamweaver, formation dreamweaver, créer site web." />
...
<table width="919" height="822" align="center" bgcolor="#FFFFFF" bordercolor="#CCCCCC">
 ...
 <th width="160" rowspan="2" scope="col" class="arrowlistmenu">
  ...
  <tr>
    <td height="93"><p align="center" class="Style13"><a href="./Cours-dreamweaver-creer-un-site-web-avec-Dreamweaver.php"><strong>Cours Dreamweaver</strong></a></p>
      <p align="center" class="Style9">Créer votre site web avec Dreamweaver</p> </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="4" class="Style12"><table width="552" height="194" border="0" align="center">
      <tr>
        <th width="373" rowspan="2" class="Style13" scope="col"><p align="center"><div class="fb-like" data-href="./Cours-dreamweaver-creer-un-site-web-avec-Dreamweaver.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div></p>
          <p align="left">Dreamweaver est néanmoins incontournable dès que l'on parle de création de sites web.Au fil des versions, le logiciel de Macromedia a réussi à se forger une réputation crédible loin de l'image un peu péjorative de  &quot;Word pour pages HTML&quot; et devenir une vraie solution d'édition et de développement. Débarassé de ses suffixes à rallonge.</p>
          <p align="left">&nbsp;</p>
          <div align="center"><class="floatbox style5 style13" rev="width:800 height:450 scrolling:no caption:" target="_blank" rel="nofollow"><img src="images/tuto1[2].jpg" alt="partie 1" width="114" height="30" border="0"></a><class="floatbox style5 style13" rev="width:800 height:450 scrolling:no caption:" target="_blank" rel="nofollow">  <img src="images/tuto2[2].jpg" alt="partie 2" width="114" height="30" border="0"></a></div></th>
        <th width="169" height="137" scope="col"><div align="right"><a href="./Cours-dreamweaver-creer-un-site-web-avec-Dreamweaver.php"><img src="images/dreamweaver1.jpg" alt="dreamweaver tutorial" width="150" height="150" border="0"></a></div></th>
      </tr>
      <tr>
        <td height="24">&nbsp;</td>
      </tr>
