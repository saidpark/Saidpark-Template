...
<title>Programmer un microcontrôleur PIC 16F84 en Entée avec MiKroC et ISIS | Maroc électronique et robotique</title>
<META name=title content="Programmer un microcontrôleur PIC 16F84 en Entée avec MiKroC et ISIS | Maroc électronique et robotique">

<META lang=fr name=description content="Dans notre dernièr cours nous avons programmé Le multiplexage de plusieurs afficheur 7 segments pic 16F84 en MiKroC, nous allons revenir aujourd'hui plus en détail sur les ports d'Entrées-sorties ainsi que leur mode de configuration. " />
<meta name="keywords" content="pic, max232 pic, micro pic, pic vert, microcontroleur pic, MikroC, isis, entrée,Pic,16F88,projet,modelisme,MikroC et entrée sur Pic 16F84, pic projet, led pic, pic simulation, pic radio, electrique pic, circuit pic, pic programmation, pic 16f84, pic 16f88 conversion, fournisseurs de pic 16f88, voltmetre pic 16f88, pwm pic 16f88, programmation pic 16f88, oscillateur interne pic 16f88, PWM PIC 16F88" />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./Programmer-un-microcontroleur-pic-16f84-en-Entree-avec-MiKroC-et-ISIS.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./Programmer-un-microcontroleur-pic-16f84-en-Entree-avec-MiKroC-et-ISIS.php">Cours de programmation Microcontroleur PIC16F84</a></p>
    <p align="center" class="Style12">Programmer un microcontrôleur PIC 16F84 en Entée avec MiKroC et ISIS </p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6"><span class="Style12">1 - Présentation</span></p>
          <p class="Style6">Dans notre dernièr cours nous avons programmé <a href="./programmer-un-afficheur-7-segments-avec-microcontroleur-pic-16f84-en-MiKroC-et-ISIS.php" target="_blank">Le multiplexage de plusieurs afficheur 7 segments pic 16F84 en MiKroC</a>, nous allons revenir aujourd'hui plus en détail sur les ports d'Entrées-sorties ainsi que leur mode de configuration.<br>
            Les deux ports du PIC 16F84 sont respectivement composés de 5 broches d'Entrées-Sorties pour le port A (RA0 à RA4) et de 8 broches Entrées-Sorties pour le ports B (RB0 à RB7)</p>
          <p class="Style12">2 - Configuration du registre TRIS </p>
          <p class="Style6">Lorsque vous allez utiliser un PIC et créer un programme il sera nécessaire de configurer les ports A et B selon le projet que vous allez réalisez.<br>
            Deux registres internes spécifique de 8 bits nommés TRISA pour la configuration du ports A et TRISB pour la configuration du port B vont vous permettre de définir le sens de chacune des 13 lignes d'Entrées-Sorties.<br>
            Prenons de suite un exemple<br>
            Nous devons réaliser un projet nécessitant des Entrées-Sorties à l'aide d'un PIC 16F84.</p>
          <p class="Style6"><span class="Style12">Prérequis</span></p>
          <p class="Style6">Ce tutorial demande des connaissances théoriques sur la programmation en assembleur PIC 16F84, présentées dans le chapitre <a href="./Programmer-en-assembleur-un-PIC16F84A.php" target="_blank">« Programmer en assembleur un PIC16F84A». </a>un jeu de lumière et un feu rouge en pic 16F84 sous MikroC sont réalisés dans le chapitre <a href="./Programmer-un-jeu-de-lumiere-et-un-feu-rouge-en-assembleur-pic-16F84-sous-MikroC-et-ISIS.php" target="_blank">« Cours de programmation Microcontroleur PIC16F84 »</a>. et le chapitre « <a href="./programmer-un-afficheur-7-segments-avec-microcontroleur-pic-16f84-en-MiKroC-et-ISIS.php" target="_blank">Programmer un afficheur 7 segments microcontroleur pic 16F84 en MiKroC</a> » Il est recommandé d'en prendre connaissance avant de voir ce chapitre</p></td>
        <td width="175"><p align="right"><img src="images/electronic-repair1.jpg" alt="microcontroleur pic 16f84" width="266" height="219"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
