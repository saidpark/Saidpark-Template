...
<title>CCNA Les notions de base sur les réseaux CISCO | La Certification CCNA</title>
<META name=title content="CCNA Les notions de base sur les réseaux CISCO | La Certification CCNA">
<META lang=fr name=description content="De plus en plus, les réseaux qui nous relient continues à s’étendre, la plateforme de communication qui relie ces réseaux et le prend en charge doit également se développer. En théorie, un fichier mp3, une vidéo ou un courriel, pourrait être transmise à travers un réseau source vers une destination sous forme de bits à travers une voie appelé Canal par laquelle le message peut se déplacer depuis la source vers la destination." />
<meta name="keywords" content="réseaux, réseau informatique, sécurité réseau, logiciel réseau, configuration réseau, réseau informatiques, administration réseau, vlan, vlan cisco, cisco, switch, vlan switch, switch cisco, périphériques réseaux," />
...
<div align="right" bgcolor="#ffffff">
  ...
  <tr>
    <td height="97">
    <div class="fb-like" data-href="./CCNA-Notions-de-base-sur-les-reseaux-CISCO.php" data-send="true" data-layout="button_count" data-width="358" data-show-faces="false"></div>
   
    <p align="center" class="Style14"><a href="./CCNA-Notions-de-base-sur-les-reseaux-CISCO.php">Formation réseau (Certification CCNA) </a></p>
    <p align="center" class="Style12"> CCNA Les notions de base sur les réseaux CISCO </p><br>    </td>
  </tr>
  <tr>
...
<h3 align="left" class="headerbar">Annonces</h3></td>
    <td rowspan="2"><table width="583" height="77" border="0">
      <tr>
        <td width="398"><p class="Style6">Ce cours porte sur ces aspects du réseau d’informations:</p>
          <ul>
            <li class="Style6">périphériques qui constituent le réseau</li>
            <li class="Style6">supports reliant les périphériques</li>
            <li class="Style6">messages qui circulent sur le réseau</li>
            <li class="Style6">règles et processus qui gèrent les communications sur le réseau</li>
            </ul>
          <p class="Style6">De plus en plus, les réseaux qui nous relient continues à s’étendre, la plateforme de communication qui relie ces réseaux et le prend en charge doit également se développer.<br>
            En théorie, un fichier mp3, une vidéo ou un courriel, pourrait être transmise à travers un réseau source vers une destination sous forme de bits à travers une voie appelé Canal par laquelle le message peut se déplacer depuis la source vers la destination.</p>
          <p class="Style6">par exemple, si vous désirez de communiquer à l’aide de mots, d’images et de sons, chacun de ces messages sont converties en chiffres binaires, ou bits. Ces bits sont ensuite codés pour former un signal qui peut être transmis via le support approprié. Dans les réseaux informatiques, le support est généralement un type de transmission par câble ou sans fil.</p>
          <p class="Style6">Il existe une meilleure approche, qui consiste à diviser les données en petites taille pour les envoyer facilement sur le réseau, c'est ce qu'on appelle la segmentation.<br>
            Les réseaux de données sont des systèmes composés de périphériques finaux et de périphériques intermédiaires et des supports<br>
            Plusieurs types de périphériques contribuent à garantir une communication entre une source et une destination.</p>
          <ul>
            <li class="Style6">Ordinateurs (stations de travail, ordinateurs portables, serveurs de fichiers, serveurs Web)</li>
            <li class="Style6">Imprimantes réseau</li>
            <li class="Style6">Téléphones VoIP</li>
            <li class="Style6">Caméras de surveillance</li>
            <li class="Style6">Périphériques portables mobiles (par exemple, lecteurs de codes à barres sans fil ou assistants numériques personnels)</li>
            <li class="Style6">Périphériques d’accès réseau (concentrateurs, commutateurs et points d’accès sans fil)</li>
            <li class="Style6">Périphériques interréseau (routeurs)</li>
            <li class="Style6">Serveurs et modems de communication</li>
            <li class="Style6">Périphériques de sécurité (pare-feu)</li>
            <li class="Style6">Serveurs et modems de communication</li>
            <li class="Style6">Périphériques de sécurité (pare-feu)</li>
          </ul>
          </td>
        <td width="175"><p align="right"><img src="images/59888_119112651477433_722736_n.jpg" alt="switching ccna" width="259" height="209"></p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
          <p align="right">&nbsp;</p>
    ...
    </table>    <p class="Style6">
      Dans ce cours, nous allons décrire les procédures et le rôle de chaque périphériques dans un réseau informatique</p>
